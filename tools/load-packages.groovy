...
class LoadPackages {
    ...
    private final String SCRIPT_NAME = "load-packages.groovy"
    ...
    def run() {
        ...
        //retrieve all (package, bucket) pairs in a map: package_bucket_map. This map will be used to check
        // if there are buckets not defined in the ordered_bucket_list file
        ...
        //Add missing bucket if they exist
