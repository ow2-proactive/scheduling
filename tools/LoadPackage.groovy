...
class LoadPackage {
    ...
    def pushObject(object, package_dir, bucket_resources_list, bucket_id) {
        ...
        if (!object_found) {
            ...
            // POST QUERY
            def query_push_obj_query = this.CATALOG_URL + "/buckets/" + bucket_id + "/resources?name=" + object_name + "&kind=" + kind + "&commitMessage=" + commitMessageEncoded + "&objectContentType=" + contentType
