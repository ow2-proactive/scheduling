...
/**
 * Allows to remotely call role-based methods (e.g. read, write, admin) of the service.
 */
public class ServiceRolePermission extends ClientPermission {
    ...
    public ServiceRolePermission(String name) {
        super(name);
    }
}
