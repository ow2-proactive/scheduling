...
public final class CommandLineBuilder implements Cloneable {
    ...
    private String deploymentMode = "autoGenerated";

    private String nodeJarUrl;
    ...
    public void setNodeJarUrl(String nodeJarUrl) {
        this.nodeJarUrl = nodeJarUrl;
    }
    ...
    public String buildCommandLine(boolean displayCredentials) throws IOException {
        if (!deploymentMode.equals("autoGenerated")) {
    ...
    private String buildCommandLineFromScript(boolean displayCredentials) {
        ...
        String cmdLine;
        if (deploymentMode.equals("useStartupScript")) {
            cmdLine = InitScriptGenerator.fillInStandardScriptProperties(startupScript,
                                                                         javaPath,
                                                                         rmHome,
                                                                         rmURL,
                                                                         fileEncoding,
            ...
            cmdLine = InitScriptGenerator.fillInNodeJarScriptProperties(startupScript,
                                                                        nodeJarUrl,
                                                                        rmURL,
                                                                        javaOptions,
                                                                        nodeName,
