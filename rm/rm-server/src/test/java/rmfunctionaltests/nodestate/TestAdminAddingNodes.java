 ...
 */
package rmfunctionaltests.nodestate;
...
public class TestAdminAddingNodes extends RMFunctionalTest {
    ...
    public void testAddNodes() throws Exception {
        ...
        resourceManager.createNodeSource(NS_NAME,
        ...
        RMTHelper.log("Test 1 : add a node");
        ...
        RMTHelper.log("Test 2 : remove an already deployed node");
        ...
        RMTHelper.log("Test 3 : add a node, kill this node, node is detected down, and add a node that has the same URL");
        ...
        RMTHelper.log("Test 4 : add a node, keep this node free, kill this node, and add a node that has the same URL");
        ...
        RMTHelper.log("Test 5 : add a node, put this node busy, kill this node, and add a node that has the same URL");
        ...
        RMTHelper.log("Test 6 : add a node, put this node toRelease, kill this node, and add a node that has the same URL");
