 ...
 */
package rmfunctionaltests.nonblockingcore;
...
import rmfunctionaltests.selectionscript.SelectionScriptTimeOutTest;
...
public class NonBlockingCoreTest extends RMFunctionalTest {
    ...
    public void action() throws Exception {
        String rmconf = new File(PAResourceManagerProperties.getAbsolutePath(getClass().getResource("/rmfunctionaltests/config/functionalTRMProperties-long-selection-script-timeout.ini")
