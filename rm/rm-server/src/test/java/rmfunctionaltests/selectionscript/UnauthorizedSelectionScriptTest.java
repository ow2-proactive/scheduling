 ...
 */
package rmfunctionaltests.selectionscript;
...
public class UnauthorizedSelectionScriptTest extends RMFunctionalTest {
    ...
    public void action() throws Exception {
        String rmconf = new File(PAResourceManagerProperties.getAbsolutePath(getClass().getResource("/rmfunctionaltests/config/rm-authorized-selection-script.ini")
