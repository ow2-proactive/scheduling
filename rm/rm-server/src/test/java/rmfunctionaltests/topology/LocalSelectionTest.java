 ...
 */
package rmfunctionaltests.topology;
...
public class LocalSelectionTest extends RMFunctionalTest {
    ...
    public void getRM() throws Exception {
        String rmconf = new File(PAResourceManagerProperties.getAbsolutePath(getClass().getResource("/rmfunctionaltests/config/functionalTRMPropertiesWithTopology.ini")
