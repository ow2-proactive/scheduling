...
public class SSHInfrastructureV2 extends HostsFileBasedInfrastructureManager {
    ...
    @Configurable(description = "autoGenerated, useStartupScript or useNodeJarStartupScript. Please refer to the manual", sectionSelector = 1)
    ...
    @Configurable(textArea = true, description = "Startup script that will download a node.jar and start ProActive Agent using it. Used only when useNodeJarStartupScript mode is selected", sectionSelector = 3)
