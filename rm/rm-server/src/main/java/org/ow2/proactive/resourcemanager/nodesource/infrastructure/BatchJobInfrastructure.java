...
public abstract class BatchJobInfrastructure extends InfrastructureManager {
     ...
     * host
     */
    @Configurable(textAreaOneLine = true, description = "Options for the java command\nlaunching the node on the remote hosts", sectionSelector = 3)
    ...
    public String toString() {
        return getBatchinJobSystemName() + ", maxNodes: [" + this.maxNodes + "], nodeTimeOut: [" + nodeTimeOut + "]";
    }
