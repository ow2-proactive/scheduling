...
public class RMProxyUserInterface extends RMListenerProxy implements ResourceManager {
    ...
    /**
     * @see org.ow2.proactive.resourcemanager.frontend.ResourceManager#redeployNodeSource(String)
     */
    public BooleanWrapper redeployNodeSource(String arg0) {
        return target.redeployNodeSource(arg0);
    }
    ...
    public BooleanWrapper checkNodePermission(String nodeUrl, boolean provider) {
        return this.target.checkNodePermission(nodeUrl, provider);
    }
