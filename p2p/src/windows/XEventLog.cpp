...
// ctor
// 
// Purpose:     Construct XEventLog object.
// 
...
// Returns:     None
//
XEventLog::XEventLog(LPCTSTR lpszApp /*= NULL*/,
					   LPCTSTR lpszEventMessageDll /*= NULL*/)
{
#ifdef _DEBUG
	if ((lpszApp == NULL) || (lpszApp[0] == _T('\0')))
	{
		TRACE(_T("=== No app specified in XEventLog ctor. ")
...
// dtor
// 
// Purpose:     Destroy XEventLog object.
// 
// Parameters:  none
// 
// Returns:     none
...
//
BOOL XEventLog::Init(LPCTSTR lpszApp, LPCTSTR lpszEventMessageDll /*= NULL*/)
{
...
// Returns:     BOOL - TRUE = success
// 
BOOL XEventLog::Write(WORD wType, LPCTSTR lpszMessage)
{
	BOOL bRet = TRUE;
...
// Returns:     BOOL - TRUE = success
//
BOOL XEventLog::RegisterSource(LPCTSTR lpszApp,
...
// Returns:     none
// 
void XEventLog::SetAppName(LPCTSTR lpszApp)
{
	if (!lpszApp)
		return;
	if (!m_pszAppName)
