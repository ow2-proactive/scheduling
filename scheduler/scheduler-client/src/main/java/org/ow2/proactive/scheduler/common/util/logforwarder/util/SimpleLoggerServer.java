...
public class SimpleLoggerServer implements Runnable {
    ...
    private final LogForwardingService.LoggingEventProcessor eventProcessor;
     ...
     * @param eventProcessor the name of the appender in which redirect log events.
     *                     if null, events are redirected into all appenders.
     * @throws IOException
     */
    public SimpleLoggerServer(int port, LogForwardingService.LoggingEventProcessor eventProcessor) throws IOException {
     ...
     * @throws IOException
     */
    public SimpleLoggerServer(LogForwardingService.LoggingEventProcessor eventProcessor) throws IOException {
     ...
     */
    public static SimpleLoggerServer createLoggerServer(LogForwardingService.LoggingEventProcessor eventProcessor) throws IOException {
