...
public class JobRemoveHandlerTest {
	...
	private String jobName = "JobRemoveHandlerTest";
	...
	public void testJobRemovedAndstatusUpdated(){
		...
		Mockito.verify(dbManager,Mockito.times(1)).removeJob(org.mockito.Matchers.any(JobId.class), org.mockito.Matchers.anyLong(),org.mockito.Matchers.anyBoolean() );
		Mockito.verify(listener,Mockito.times(1)).jobStateUpdated(org.mockito.Matchers.anyString(), org.mockito.Matchers.any(NotificationData.class));
