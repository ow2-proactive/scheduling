 ...
 */
package schedulerserverfunctionaltests.runasme;
...
import schedulerserverfunctionaltests.dataspaces.TestCacheSpaceCleaning;
import functionaltests.utils.RMTHelper;
import schedulerserverfunctionaltests.utils.SchedulerTHelper;
import schedulerserverfunctionaltests.utils.SchedulerFunctionalTest;
...
public class TestRunAsMeLinuxPwd extends TestRunAsMe {
    ...
    public static void startDedicatedScheduler() throws Exception {
        ...
        SchedulerFunctionalTest.schedulerHelper = new SchedulerTHelper(true, true);
        ...
        SchedulerFunctionalTest.schedulerHelper.createNodeSource("RunAsMeNSPwd", 5, arguments);
    }

    @Test
    public void testRunAsMe() throws Exception {
        // connect to the scheduler using the runasme account
        Scheduler scheduler = SchedulerFunctionalTest.schedulerHelper.getSchedulerInterface(username, password, null);
        JobId jobid = SchedulerFunctionalTest.schedulerHelper.testJobSubmission(scheduler,
