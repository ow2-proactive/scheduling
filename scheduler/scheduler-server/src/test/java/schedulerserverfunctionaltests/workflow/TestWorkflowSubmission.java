 ...
 */
package schedulerserverfunctionaltests.workflow;
...
public class TestWorkflowSubmission extends TRepJobs {
    ...
    private static final URL jobs_path = TestWorkflowSubmission.class.getResource("/functionaltests/workflow/descriptors/");
    ...
    private void testFail() throws Throwable {
        ...
        for (int i = 0; i < jobs_fail; i++) {
            String job_path = new File(jobs_path.toURI()).getAbsolutePath() + "/flow_fail_" + (i + 1) + ".xml";
            ...
            Assert.assertTrue("Job " + job_path + " was supposed to be rejected but was created", job == null);
