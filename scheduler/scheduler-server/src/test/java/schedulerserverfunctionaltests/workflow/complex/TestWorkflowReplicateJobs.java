...
import schedulerserverfunctionaltests.workflow.TRepJobs;
...
public class TestWorkflowReplicateJobs extends TRepJobs {
    ...
    public void testWorkflowReplicateJobs() throws Throwable {
        ...
        TRepCase t3 = new TRepCase(prefix + "3.xml", 14, "T6,2,18 T7,1,19 T,1,0 T4,2,6 T5,2,6 T1,2,2 T3,2,4 T2,2,4");
        ...
        TRepCase t7 = new TRepCase(prefix + "7.xml",
                                   30,
                                   "T6,2,38 T7,1,45 T,1,0 T4,4,16 T10,4,12 T5,2,6 T11,4,36 T8,2,4 T9,4,16 T1,2,2 T3,2,4 " +
                                       "T2,2,2");
