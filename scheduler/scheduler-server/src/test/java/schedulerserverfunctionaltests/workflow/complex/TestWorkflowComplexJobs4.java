...
public class TestWorkflowComplexJobs4 extends TRepJobs {
    ...
    public void testWorkflowComplexJobs4() throws Throwable {
        ...
        TRepCase t2 = new TRepCase(prefix + "2.xml", 10, "T6,1,-1 T7,1,11 T,1,0 T4,1,10 T5,1,-1 T1,1,1 T3,3,9 T2,1,2");
        TRepCase t3 = new TRepCase(prefix + "3.xml",
                                   26,
                                   "T6,2,4 T7,6,18 T,1,0 T4,2,28 T5,1,29 T8,6,24 T9,2,26 T1,2,2 T3,2,-2 " + "T2,2,-2");
        TRepCase t4 = new TRepCase(prefix + "4.xml",
                                   95,
