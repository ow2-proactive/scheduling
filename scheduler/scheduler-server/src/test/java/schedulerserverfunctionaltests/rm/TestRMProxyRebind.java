...
public class TestRMProxyRebind extends MultipleRMTBase {
    ...
    private void testRebind(URI rmUri1, URI rmUri2, ResourceManager rm1, ResourceManager rm2,
        ...
        SchedulerTHelper.log("Get one node with RM1");
        ...
        SchedulerTHelper.log("Rebinding to " + rmUri2);
        ...
        SchedulerTHelper.log("Get one node with RM2");
        ...
        SchedulerTHelper.log("Get two nodes with RM2");
        ...
        SchedulerTHelper.log("Release one node with RM2");
        ...
        SchedulerTHelper.log("Release two nodes with RM2");
        ...
        SchedulerTHelper.log("Try to release node with terminated RM1");
        proxy1.releaseNodes(rm1NodeSet2);

        SchedulerTHelper.log("Try to release node with terminated RM1 one more time");
        proxy1.releaseNodes(rm1NodeSet2);
