...
import schedulerserverfunctionaltests.utils.SchedulerTestConfiguration;
import schedulerserverfunctionaltests.utils.TestScheduler;
...
public class TestOperationsWhenUnlinked extends ProActiveTest {
    ...
    public void testSubmitAndPause() throws Throwable {
        ...
        SchedulerTHelper.log("Submitting new job");
        ...
        SchedulerTHelper.log("Creating new RM");
