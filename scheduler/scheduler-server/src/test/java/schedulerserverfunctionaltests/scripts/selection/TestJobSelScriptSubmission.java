 ...
 */
package schedulerserverfunctionaltests.scripts.selection;
...
public class TestJobSelScriptSubmission extends SchedulerFunctionalTestNoRestart {
    ...
    private static URL jobDescriptor = TestJobSelScriptSubmission.class.getResource("/functionaltests/descriptors/Job_with_select_script.xml");
