 ...
 */
package schedulerserverfunctionaltests.job;
...
public class TestVariablesPropagation extends SchedulerFunctionalTestWithCustomConfigAndRestart {
    ...
    private void testVariablesPropagation(String jobDescriptorPath) throws Exception {
        ...
        SchedulerTHelper.log(schedulerHelper.getSchedulerInterface().getClass().toString());
        ...
        //Wait for finish
        SchedulerTHelper.log("Wait for event t1 finished");
        schedulerHelper.waitForEventTaskFinished(id, "t1");
        SchedulerTHelper.log("Wait for event t2 finished");
