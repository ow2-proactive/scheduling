 ...
 */
package schedulerserverfunctionaltests.job.taskkill;
...
public class TestProcessTreeKiller extends SchedulerFunctionalTestWithRestart {
    ...
    public void testProcessTreeKiller() throws Throwable {
        ...
        for (int i = 0; i < NB_ITERATIONS; i++) {
            ...
            //kill the first job
            SchedulerTHelper.log("************** Waiting for the first job (NativeExecutable) to be killed *************");
            ...
            //kill the second job
            SchedulerTHelper.log("************** Waiting for the second job (JavaExecutable) to be killed *************");
            ...
            SchedulerTHelper.log("************** Waiting for first job (NativeExecutable) to finish *************");
            ...
            SchedulerTHelper.log("************** Waiting for second job (JavaExecutable) to finish *************");
    ...
    public static void waitUntilForkedProcessesAreRunning(int expectedNumber) throws Exception {
        SchedulerTHelper.log("************** Waiting until " + expectedNumber + " processes are left *************");
