...
import schedulerserverfunctionaltests.executables.EndlessExecutable;
...
public class TestJobWalltime extends SchedulerFunctionalTestWithRestart {
    ...
    public JobId walltimeNativeTask() throws Throwable {
        assumeFalse("This test fails on windows because the ProcessTreeKiller is not working",
