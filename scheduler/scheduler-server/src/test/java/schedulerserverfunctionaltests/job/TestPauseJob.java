...
public class TestPauseJob extends SchedulerFunctionalTestNoRestart {
    ...
    public void test() throws Throwable {
        ...
        SchedulerTHelper.log("Submitted job " + jobId);

        SchedulerTHelper.log("Waiting for task1 to start");
        ...
        SchedulerTHelper.log("Pause the job " + jobId);
        ...
        SchedulerTHelper.log("Checking is the status of task2 remains unchanged");
        Thread.sleep(5000);
        js = schedulerHelper.getSchedulerInterface().getJobState(jobId);
        assertEquals(TaskStatus.PAUSED, getTaskState("task2", js).getStatus());
    }
