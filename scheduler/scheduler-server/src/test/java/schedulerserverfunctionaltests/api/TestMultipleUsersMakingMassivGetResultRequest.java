 ...
 */
package schedulerserverfunctionaltests.api;
            ...
            new Thread() {
                ...
                public void run() {
                    try {
                        ...
                        SchedulerTHelper.log(Thread.currentThread().getName() + " -> Connecting the scheduler");
                        ...
                        int submitted = 1;
                        while (true) {
                            SchedulerTHelper.log(Thread.currentThread().getName() + " -> Submit (" + submitted + ")");
