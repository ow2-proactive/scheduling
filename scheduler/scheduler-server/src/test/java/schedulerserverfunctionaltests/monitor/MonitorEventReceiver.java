 ...
 */
package schedulerserverfunctionaltests.monitor;
...
public class MonitorEventReceiver implements SchedulerEventListener {
    ...
    public void schedulerStateUpdatedEvent(SchedulerEvent eventType) {
        SchedulerTHelper.log("SchedulerEvent: " + eventType);
        switch (eventType) {
            case STARTED:
            case STOPPED:
            case KILLED:
    ...
    public void jobStateUpdatedEvent(NotificationData<JobInfo> notification) {
        SchedulerTHelper.log("NotificationData: " + notification);
    ...
    public void jobSubmittedEvent(JobState jState) {
        SchedulerTHelper.log("JobState: " + jState);
    ...
    public void jobUpdatedFullDataEvent(JobState job) {
        SchedulerTHelper.log("JobState: " + job);
