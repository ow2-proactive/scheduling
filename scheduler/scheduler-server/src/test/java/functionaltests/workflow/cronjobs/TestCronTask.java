...
public class TestCronTask extends CronCheckBase {
    ...
    public void testSimpleCronTask() throws Exception {
        ...
        // first iteration
        TaskInfo taskInfo = schedulerHelper.waitForEventTaskFinished(jobId, "SimpleCronTask", task_timeout);
        assertEquals(FINISHED, taskInfo.getStatus());

        // second iteration
        TaskInfo taskInfo2 = schedulerHelper.waitForEventTaskFinished(jobId, "SimpleCronTask#1", task_timeout);
