...
public class TestTimedDoTaskAction extends SchedulerConsecutive {

    @Test
    public void testThatCredentialsAreCreatedIfThirdPartyCredentialHaveBeenDefined() throws Exception {
        SchedulerTHelper.getSchedulerInterface().putThirdPartyCredential("mykey", "myvalue");
        Assert.assertEquals("{mykey=myvalue}", createAndSubmitTaskPrintingCredentials());
    }
