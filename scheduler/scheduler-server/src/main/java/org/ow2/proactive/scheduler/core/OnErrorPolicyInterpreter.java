...
public class OnErrorPolicyInterpreter {
    ...
    private boolean propertyIs(UpdatableProperties<OnTaskError> onTaskErrorProperty, OnTaskError onTaskError) {
        return onTaskErrorProperty.isSet() && onTaskErrorProperty.getValue().toString().equals(onTaskError.toString());
    }
