...
public class JobEmailNotification {
    ...
    private static final String BODY_TEMPLATE = "This email was auto-generated by ProActive Workflows & Scheduling (PWS) installed on Host http://%4$s:8080. Please do not reply.\n\n" +
                                                "This notification is to inform you that the Job ID: %1$s " +
                                                "is %2$s.\n\n" +
                                                "Below, you find the list of job tasks and their statuses: \n" +
                                                "%3$s\n\n" +
                                                "You can also access to the job details on the Scheduling portal following this link: http://%4$s:8080/scheduler/?job=%1$s\n\n" +
                                                "If you have any questions or concerns, please contact us at support@activeeon.com";
