...
public interface Converter<T> {
    ...
    /**
     * Converts the specified string parameter {@code value} to a given type. If the conversion is impossible,
     * a checked exception that contains the cause is thrown.
     *
