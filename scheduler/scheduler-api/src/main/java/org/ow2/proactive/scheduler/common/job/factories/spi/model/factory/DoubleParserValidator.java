...
import org.ow2.proactive.scheduler.common.job.factories.spi.model.converter.DoubleConverter;
...
public class DoubleParserValidator extends RangeParserValidator<Double> {
    ...
    @Override
    protected Converter<Double> createConverter(String model) throws ModelSyntaxException {
