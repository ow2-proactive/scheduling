...
import org.ow2.proactive.scheduler.common.job.factories.spi.model.converter.IntegerConverter;
...
public class IntegerParserValidator extends RangeParserValidator<Integer> {
    ...
    @Override
    protected Converter<Integer> createConverter(String model) throws ModelSyntaxException {
