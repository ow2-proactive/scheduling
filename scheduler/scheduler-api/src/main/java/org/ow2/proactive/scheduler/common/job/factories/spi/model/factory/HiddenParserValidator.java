...
public class HiddenParserValidator extends BaseParserValidator<String> {

    public HiddenParserValidator(String model) throws ModelSyntaxException {
        super(model, ModelType.HIDDEN);
    }
