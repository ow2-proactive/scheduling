...
/**
 * Exception generated when trying to retrieve a label that does not exist.<br>
 *
 * @author The ProActive Team
 * @since ProActive Scheduling 1.0
 */
@PublicAPI
public class LabelNotFoundException extends SchedulerException {

    public LabelNotFoundException(String label) {
        super("Label with id " + label + " was not found !");
    }
