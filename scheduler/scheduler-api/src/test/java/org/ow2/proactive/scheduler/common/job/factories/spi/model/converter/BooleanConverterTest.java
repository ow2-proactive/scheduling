...
public class BooleanConverterTest {
    ...
    @Test
    public void testBooleanConverterOK() throws ConversionException {
        BooleanConverter converter = new BooleanConverter();
        Assert.assertEquals(true, converter.convert("true"));
        Assert.assertEquals(true, converter.convert("1"));
        Assert.assertEquals(false, converter.convert("false"));
        Assert.assertEquals(false, converter.convert("0"));
    }

    @Test(expected = ConversionException.class)
    public void testBooleanConverterKO() throws ConversionException {
        BooleanConverter converter = new BooleanConverter();
