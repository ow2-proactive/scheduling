...
public class DoubleConverterTest {
    ...
    @Test
    public void testDoubleConverterOK() throws ConversionException {
        DoubleConverter converter = new DoubleConverter();
        Assert.assertEquals(0.0, converter.convert("0"), 0.0);
        Assert.assertEquals(Double.MAX_VALUE, converter.convert("" + Double.MAX_VALUE), 0.0);
    }

    @Test(expected = ConversionException.class)
    public void testDoubleConverterKOOutOfRange() throws ConversionException {
        DoubleConverter converter = new DoubleConverter();
        converter.convert("" + Double.POSITIVE_INFINITY);
    }

    @Test(expected = ConversionException.class)
    public void testDoubleConverterKONotFloat() throws ConversionException {
        DoubleConverter converter = new DoubleConverter();
