...
public abstract class JavaExecutable extends AbstractJavaExecutable {
    ...
    public final NodeSet getNodes() {
        return getJavaExecutableInitializerImpl().getNodes();
    }
    ...
    public final DataSpacesFileObject getInputSpace() throws FileSystemException {
        return getJavaExecutableInitializerImpl().getInputSpaceFileObject();
    }
    ...
    public final DataSpacesFileObject getOutputSpace() throws FileSystemException {
        return getJavaExecutableInitializerImpl().getOutputSpaceFileObject();
    }
    ...
    public final DataSpacesFileObject getGlobalSpace() throws FileSystemException {
        return getJavaExecutableInitializerImpl().getGlobalSpaceFileObject();
    }
    ...
    public final DataSpacesFileObject getUserSpace() throws FileSystemException {
        return getJavaExecutableInitializerImpl().getUserSpaceFileObject();
    }
    ...
    public final DataSpacesFileObject getLocalSpace() throws FileSystemException {
        return getJavaExecutableInitializerImpl().getLocalSpaceFileObject();
    }
    ...
    private JavaExecutableInitializerImpl getJavaExecutableInitializerImpl() {
        return (JavaExecutableInitializerImpl) super.execInitializer;
    }
