 ...
 */
public class ForkerStarterTest {

    private static final Logger logger = Logger.getLogger(ForkerStarterTest.class);
    ...
    public static void main(String[] args) {
        ...
        BasicConfigurator.configure(new ConsoleAppender(new PatternLayout("[%d{ISO8601} %-5p] %m%n")));
        Logger.getRootLogger().setLevel(Level.INFO);
        logger.fatal("Start");
//        if (args.length != 2) {
//            System.err.println(ForkerStarterTest.class.getSimpleName() +
...
//        }
        ...
        ForkerStarterTest fs = new ForkerStarterTest();
        Node n = fs.createLocalNode("test");
