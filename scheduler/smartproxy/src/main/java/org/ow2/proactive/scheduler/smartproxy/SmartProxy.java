...
public class SmartProxy extends SchedulerProxyUserInterface implements InitActive, EndActive,
    ...
    private transient JobTrackerImpl jobTracker = new JobTrackerImpl();
     ...
     */
    protected transient Set<SchedulerEventListenerExtended> eventListeners = Collections
     ...
     *                              the SchedulerEventListenerExtended interface will be sent to the listeners upon transfer
    ...
    protected void removeJobIO(Job job, String push_url, String pull_url, String newFolderName)
        ...
        FileObject fo = jobTracker.resolveFile(push_url_updated);
        try {
        ...
        fo = jobTracker.resolveFile(pull_url_updated);
        try {
            fo.delete(Selectors.SELECT_ALL);
            fo.delete();
        } catch (Exception e) {
    ...
    protected void createFolder(String fUri) throws FileSystemException {
        ...
        FileObject fo = jobTracker.resolveFile(fUri);
        fo.createFolder();
