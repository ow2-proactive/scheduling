...
/* Function invoke_u is called with more than 2 arguments : invoke(obj,method,arg1,...,argn)
   ...
   The resulting object is unwrapped if it is possible.
*/
int
sci_invoke_u (char *fname)
{
  if (Rhs < 2) 
    {
