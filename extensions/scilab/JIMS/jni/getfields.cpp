...
void ScilabJavaObject2::getAccessibleFields (JavaVM * jvm_, int id, int pos){

  JNIEnv * curEnv = NULL;
  jvm_->AttachCurrentThread(reinterpret_cast<void **>(&curEnv), NULL);
  jclass cls = curEnv->FindClass(className().c_str());
  
  jmethodID jobjectArray_getAccessibleMethodsjintID = curEnv->GetStaticMethodID(cls, "getAccessibleFields", "(I)[Ljava/lang/String;");
