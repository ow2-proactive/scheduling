...
%
%       InputSource - this string attribute determines which DataSpace will be used as an input DataSpace, it can either be 'input' or 'global', to use respectively the job Input Space or the Scheduler Global Space.
%
...
%
%       OutputSource - this string attribute determines which DataSpace will be used as an output DataSpace, it can either be 'ouput' or 'global', to use respectively the job Output Space or the Scheduler Global Space.
%
