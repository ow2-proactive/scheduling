...
for i = 1:length(param_files)
    ...
    PAeval_param.pwd_dir = newDir;
    PAeval_param.end_time = str2num(get(handles.Simulation_end_time,'String'));
    Tsk(i).Func = @PAsolve_modelname;
    Tsk(i).Params = {PAeval_param};
    Tsk(i).InputFiles = { [newDir '/' model_Name] , [newDir '/' param_files{i}] };
    Tsk(i).OutputFiles = { [newDir '/*.mat'] };
