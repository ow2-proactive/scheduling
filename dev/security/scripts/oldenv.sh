...
CLASSPATH=$PROACTIVE/classes:$PC


echo "CLASSPATH"=$CLASSPATH
export CLASSPATH
 
JAVACMD=$JAVA_HOME"/bin/java -Xdebug -Xnoagent -Xrunjdwp:transport=dt_socket,address=8000,server=y,suspend=n -Djava.security.manager -Djava.library.path=$PROACTIVE/lib -Djava.security.policy=$workingDir/proactive.java.policy -Dlog4j.configuration=$workingDir/proactive-log4j"
export JAVACMD
