...
public class RunCompositeControllerWrapper {
	...
	public static void main(String[] args) throws Exception{
        ...
        URI kernelUri = URI.create("http://10.0.0.118:7799");
        MoccaMainBuilder builder = new MoccaMainBuilder();
        ComponentID builderID;
		try {
			builderID = builder.addNewBuilder(kernelUri, "builder");
		} catch (CCAException e) {
			e.printStackTrace();
			System.err.println("Error connecting to kernel: " + kernelUri);
			System.exit(-1);
			return;
		}
        ...
        //pass a CCA component ID to the composite wrapper
