	...
	You can put in this addons folder jars or classes folders to
be included in the jvm's classpath.  It can be used, for instace, for
the Scheduler server, in order to to define a new scheduling policy.
