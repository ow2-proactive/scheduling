...
public class SchedulerAndRMTestDeployer {

    public static void main(String[] args) throws Exception {
        if (args.length != 4) {
            throw new TestExecutionException(
                "Invalid parameters, expected parameters: startPamrIfNeeded startRM startScheduler deployResultPropertiesFile");
        }
        ...
        String deployResultPropertiesFileName = args[3];
        ...
        System.out.println(String.format(
                "SchedulerAndRMTestDeployer, startPamrIfNeeded: %s, startRM: %s, startScheduler: %s",
