...
/**
 * Retrieves information about the processes running on each host machine.
 *
 */
public class RESTfulRMHostProcessClient extends BaseRESTfulRMHostClient {

    @Override
    protected String getQueryUrl(String serverUrl, String jmxUrl) {
        return MBeanQueries.getQueryUrl(serverUrl,
                MBeanQueries.getResourcePath(MBeanQueries.MBEAN_PROCESSES),
                jmxUrl, MBeanQueries.QUERY_PROCESSES);
    }
