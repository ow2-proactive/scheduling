...
JNIEXPORT void JNICALL PAPI_Job( JNIEnv * env, jobject jo )
/**
  INPUT PARAMETER(S):
...
/**/
{
  ...
  #ifdef PAPI_java
  {
    ...
    jobject q;
    jfieldID q_status;
    puts("PAPI_Call BEGIN\n");
    q = PAPI_Call( env, jo, "PAPI_sample", "methodejava", "(I)Ljava/lang/Object;", p1 );
    puts("PAPI_Call END\n");

    printf("PAPI_Call RETURN : %u\n",
