...
public class Source extends SimulatorElement {
    ...
    public void waitBeforeCommunication() {
        ...
        System.out.println(" Source: calling the agent after "
                           + this.remainingTime);
    }
...
//        this.server.receiveRequestFromSource();
        System.out.println("Source: communication with server started will last  "
                           + this.remainingTime);
...
//        System.out.println("<<<<< Source: communication finished at time " + endTime);
        System.out.println("TimedProxyWithLocationServer:  .............. done after "
                           + (endTime - startTime));
        this.waitBeforeCommunication();
    }
