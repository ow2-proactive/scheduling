...
public class TimedMigrationManager extends MigrationManagerImpl {
    ...
    public UniversalBody migrateTo(Node node, Body body) throws MigrationException {
        System.out.println(System.currentTimeMillis() + " TimedMigrationManager: Starting migration ");
        ...
        System.out.println(System.currentTimeMillis() + " TimedMigrationManager: length of the migration " + (endTime - startTime));
        return remote;
    }
}
