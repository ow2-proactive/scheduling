...
public class TimedRequest extends RequestImpl implements java.io.Serializable {
    ...
    public TimedRequest(MethodCall methodCall, UniversalBody sourceBody, boolean isOneWay, long sequenceID) {
...
//        }
        ...
        try {
            ...
            if (shouldMesureTime) {
                System.out.println("TimedRequest: done after " + (System.currentTimeMillis() - startTime));
            }
            else {
                System.out.println("TimedRequest: partial is  " + (System.currentTimeMillis() - startTime));
