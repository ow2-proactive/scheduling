...
public class AgentWithExponentialMigrationAndServer
    ...
    public void runActivity(Body body) {
        ...
        while (body.isActive() && (!this.stop())) {
            ...
            System.out.println(System.currentTimeMillis() +
                " AgentWithExponentialMigrationAndServer: waiting " +
        ...
        if (this.stop()) {
            System.out.println(System.currentTimeMillis() +
                " AgentWithExponentialMigrationAndServer: stoping...");
            System.exit(0);
        }
    }
    ...
    public static void main(String[] args) {
        AgentWithExponentialMigrationAndServer a = new AgentWithExponentialMigrationAndServer(new Double(
                    2), null, null);
    }
}
