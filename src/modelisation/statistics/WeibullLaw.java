...
public class WeibullLaw implements RandomNumberGenerator {
    ...
    protected Random random;
     ...
     public WeibullLaw(String variableName) {
        ...
        try {
            scale = Double.parseDouble(System.getProperties().getProperty(variableName +".weibull.scale"));
        } catch (Exception e) {
            System.err.println("WeibullLaw: property " + variableName + ".weibull.scale not set");
        }
          try {
            shape = Double.parseDouble(System.getProperties().getProperty(variableName+".weibull.shape"));
        } catch (Exception e) {
            System.err.println("WeibullLaw: property " + variableName +".weibull.shape not set");
        }
    }
