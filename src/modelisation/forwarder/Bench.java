...
public class Bench implements org.objectweb.proactive.RunActive {
    ...
    public static AgentWithExponentialMigrationAndForwarder startExponentialAgent(double d, 
        ...
        try {
            agent = (AgentWithExponentialMigrationAndForwarder)ProActive.newActive(
    ...
    public void runActivity(Body b) {
        ...
        for (int i = 0; i < 20; i++) {
            ...
            System.out.println(
                    System.currentTimeMillis() + " Bench: waiting " + 
    ...
    public static void main(String[] args) {
        ...
        AgentWithExponentialMigrationAndForwarder agent = Bench.startExponentialAgent(Double.parseDouble(
                                                                                              args[1]), 
                                                                                      nodes, 
                                                                                      args[3], 
                                                                                      Long.parseLong(
