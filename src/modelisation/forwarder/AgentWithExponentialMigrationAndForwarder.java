...
public class AgentWithExponentialMigrationAndForwarder implements ActiveWithForwarder, Serializable {
    ...
    public void live(Body body) {
        ...
        while (body.isActive()) {
            ...
            System.out.println(System.currentTimeMillis() + " AgentWithExponentialMigrationAndForwarder: waiting "
