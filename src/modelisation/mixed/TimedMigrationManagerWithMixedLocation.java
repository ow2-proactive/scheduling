...
public class TimedMigrationManagerWithMixedLocation
    ...
    public TimedMigrationManagerWithMixedLocation(LocationServer locationServer, 
                                                  double ttl, int maxMigrations) {
    ...
    public void updateLocation(Body body) {
        ...
        //        locationServer);
        System.out.println(
                " Migration Counter is " + (this.migrationCounter) + 
                " maxMigrations is " + this.maxMigrations + 
                " should update " + (this.migrationCounter % maxMigrations));
