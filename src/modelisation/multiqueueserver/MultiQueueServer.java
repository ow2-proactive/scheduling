...
public class MultiQueueServer extends SimpleLocationServer implements MultiQueueActive {
    ...
    public static void main(String args[]) {
        ...
        try {
            if (args.length == 2)
                server = (MultiQueueServer)
                        ProActive.newActive(MultiQueueServer.class.getName(),
                                            arg, args[1]);
            else
                server = (MultiQueueServer)
                        ProActive.newActive(MultiQueueServer.class.getName(),
