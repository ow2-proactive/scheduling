...
public class PADataSpacesFileStatus extends FileStatus {
	 ...
	 */
	public PADataSpacesFileStatus(long length, boolean isdir,
			int block_replication, long blocksize, long modification_time,
			Path path) {
		this(length, isdir, block_replication, blocksize, modification_time, 0,
				null, null, null, path);
	}
	...
	public PADataSpacesFileStatus(long length, boolean isdir,
		...
		this.permission = (permission == null) ? FsPermission.getDefault()
				: permission;
	...
	public PADataSpacesFileStatus(DataSpacesFileObject dataSpacesFileObject,
			DataSpacesFileObject parentDataSpacesFileObject)
	 ...
	 * @throws URISyntaxException
	 */
	protected void setDataSpacesFileObject(
		...
		if (fileType.equals(FileType.FOLDER)) {
			...
			for (DataSpacesFileObject currentDataSpacesFileObject : childDataSpacesFileObjectList) {
				try {
					length += currentDataSpacesFileObject.getContent()
							.getSize();
		...
		blocksize = length;
		modification_time = this.dataSpacesFileObject.getContent()
				.getLastModifiedTime();
		 ...
		 */
		String parentPathString = new URI(
				parentDataSpacesFileObject.getRealURI()).toString();
		String pathString = new URI(this.dataSpacesFileObject.getRealURI())
				.toString();
	...
	public int compareTo(Object o) {
		return (dataSpacesFileObject.getRealURI()
				.compareTo(((PADataSpacesFileStatus) o)
	...
	public boolean equals(Object o) {
		return (dataSpacesFileObject.getRealURI()
				.equalsIgnoreCase(((PADataSpacesFileStatus) o)
						.getDataSpacesFileObject().getRealURI()));
	}
