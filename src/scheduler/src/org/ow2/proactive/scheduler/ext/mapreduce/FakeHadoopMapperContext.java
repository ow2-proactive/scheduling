...
public class FakeHadoopMapperContext extends Context {
	...
	public FakeHadoopMapperContext(Mapper mapper, Configuration configuration,
		 ...
		 */
		mapper.super(configuration, taskAttemptID, recordReader, recordWriter,
				outputCommitter, null, inputSplit);
	}
