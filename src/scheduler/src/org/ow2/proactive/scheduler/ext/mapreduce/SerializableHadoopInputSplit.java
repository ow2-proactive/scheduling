...
public class SerializableHadoopInputSplit extends InputSplit implements Serializable {
	...
	private void readObject(java.io.ObjectInputStream in) throws IOException, ClassNotFoundException {
		...
		try {
			readObjectMethod = inputSplitClass.getMethod(READ_OBJECT_HADOOP_METHOD_NAME, new Class[]{ java.io.DataInput.class });
	...
	private void writeObject(java.io.ObjectOutputStream out) throws IOException {
		...
		try {
			writeObjectMethod = inputSplitClass.getMethod(WRITE_OBJECT_HADOOP_METHOD_NAME, new Class[]{ java.io.DataOutput.class });
		} catch (SecurityException e) {
