 ...
 */
public class MatlabCollector extends MatlabTask<AOMatlabCollector> {
    ...
    public String getWorkerClassName() {
        return AOMatlabCollector.class.getName();
    }

    @Override
    protected void initWorker(AOMatlabCollector worker) throws Throwable {
