...
public enum PAMapReduceFrameworkProperties {
	...
	WORKFLOW_FILE_SYSTEM_LOCALHOST_NAME(
			"org.ow2.proactive.scheduler.ext.mapreduce.localhost.name",
			PropertyType.STRING),

	SCHEDULER_URL("org.ow2.proactive.scheduler.ext.mapreduce.schedulerUrl",
			PropertyType.STRING),

	SCHEDULER_USERNAME("org.ow2.proactive.scheduler.ext.mapreduce.username",
			PropertyType.STRING),

	SCHEDULER_PASSWORD("org.ow2.proactive.scheduler.ext.mapreduce.password",
			PropertyType.STRING),

	SCHEDULER_HOME("org.ow2.proactive.scheduler.ext.mapreduce.schedulerHome",
			PropertyType.STRING),
	...
	WORKFLOW_CANCEL_JOB_ON_ERROR(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.cancelJobOnError",
			PropertyType.BOOLEAN),

	WORKFLOW_CLASSPATH(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.classpath",
			PropertyType.STRING),

	WORKFLOW_JVM_ARGUMENTS(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.forkedJVM.arguments",
			PropertyType.STRING),
	...
	WORKFLOW_FILE_NAME_LINKING_STRING(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.fileName.linkingString",
			PropertyType.STRING),

	WORKFLOW_FILE_SYSTEM_DEFAULT_NAME(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.fsDefaultName",
			PropertyType.STRING),

	WORKFLOW_FILE_SYSTEM_DEFAULT_IMPLEMENTATION(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.fsDefaultImplementation",
			PropertyType.STRING),

	WORKFLOW_FILE_SYSTEM_DISABLE_CACHE(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.fsDisableCache",
			PropertyType.STRING),
	...
	WORKFLOW_FILE_SYSTEM_IMPLEMENTATION_SCHEME(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.fsImplementationScheme",
			PropertyType.STRING),

	WORKFLOW_INPUT_KEY_COUNTER_NAME(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.inputKeyCounterName",
			PropertyType.STRING),
	 ...
	 */
	WORKFLOW_INPUT_SPACE(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.inputSpace",
			PropertyType.STRING),

	WORKFLOW_INPUT_VALUE_COUNTER_NAME(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.inputValueCounterName",
			PropertyType.STRING),
	...
	WORKFLOW_INTERMEDIATE_BUFFER_SIZE(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.intermediateBufferSize",
			PropertyType.STRING),
	...
	WORKFLOW_MAX_NUMBER_OF_EXECUTIONS(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.maxNumberOfExecutions",
			PropertyType.STRING),

	WORKFLOW_NUMBER_OF_MAPPER_PA_TASK(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.numberOfMapperPATask",
	 ...
	 * ProActive MapReduce job
	 */
	WORKFLOW_OUTPUT_SPACE(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.outputSpace",
			PropertyType.STRING),

	WORKFLOW_PROJECT_NAME(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.projectName",
			PropertyType.STRING),
	...
	WORKFLOW_RESTART_TASK_ON_ERROR(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.restartTaskOnError",
			PropertyType.STRING),

	WORKFLOW_SCRIPT_ENGINE(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.scriptEngineName",
			PropertyType.STRING),
	 ...
	 */
	PA_MAPREDUCE_TASK_IDENTIFIER(
			"org.ow2.proactive.scheduler.ext.mapreduce.task.identifier",
			PropertyType.STRING),
	...
	WORKFLOW_JAVA_TASK_INPUT_ACCESS_MODE_NONE(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.inputAccessModeNone",
			PropertyType.STRING),
	 ...
	 */
	WORKFLOW_JAVA_TASK_INPUT_DATASPACE(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.inputDataSpace",
			PropertyType.STRING),

	/**
	 * The property that identifies the local space of the ProActive taskflow
	 */
	WORKFLOW_JAVA_TASK_LOCAL_DATASPACE(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.localDataSpace",
			PropertyType.STRING),

	WORKFLOW_JAVA_TASK_LOGGING_DEBUG(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.logging.debug",
			PropertyType.BOOLEAN),

	WORKFLOW_JAVA_TASK_LOGGING_PROFILE(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.logging.profile",
			PropertyType.BOOLEAN),

	WORKFLOW_JAVA_TASK_OUTPUT_ACCESS_MODE_NONE(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.outputAccessModeNone",
			PropertyType.STRING),
	 ...
	 */
	WORKFLOW_JAVA_TASK_OUTPUT_DATASPACE(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.outputDataSpace",
			PropertyType.STRING),

	WORKFLOW_JAVA_TASK_RESTART_MODE_ANYWHERE(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.restartAnywhere",
			PropertyType.STRING),

	WORKFLOW_JAVA_TASK_RESTART_MODE_ELSEWHERE(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.restartElsewhere",
			PropertyType.STRING),
	...
	WORKFLOW_SPLITTER_PA_TASK_READ_MODE(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.splitterPATask.readMode",
			PropertyType.STRING),
	...
	WORKFLOW_SPLITTER_PA_TASK_NAME(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.splitterPATask.name",
			PropertyType.STRING),
	...
	WORKFLOW_MAPPER_PA_TASK_NAME(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.mapperPATask.name",
			PropertyType.STRING),
	...
	WORKFLOW_MAPPER_PA_TASK_READ_MODE(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.mapperPATask.readMode",
			PropertyType.STRING),
	...
	WORKFLOW_MAPPER_PA_TASK_WRITE_MODE(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.mapperPATask.writeMode",
			PropertyType.STRING),
	...
	WORKFLOW_MAPPER_JOIN_PA_TASK_NAME(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.mapperJoinPATask.name",
			PropertyType.STRING),
	...
	WORKFLOW_REDUCER_PA_TASK_NAME(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.reducerPATask.name",
			PropertyType.STRING),
	...
	WORKFLOW_REDUCER_PA_TASK_READ_MODE(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.reducerPATask.readMode",
			PropertyType.STRING),
	...
	WORKFLOW_REDUCER_PA_TASK_WRITE_MODE(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.reducerPATask.writeMode",
			PropertyType.STRING),
	...
	WORKFLOW_REDUCER_JOIN_PA_TASK_NAME(
			"org.ow2.proactive.scheduler.ext.mapreduce.workflow.reducerJoinPATask.name",
			PropertyType.STRING),
	...
	HADOOP_JOB_CONFIGURATION(
			"pa.scheduler.mapreduce.ext.hadoopJobConfiguration",
			PropertyType.STRING),

	HADOOP_JOB_LINE_RECORD_READER_MAX_LENGTH(
			"org.apache.hadoop.job.lineRecordReaderMaxLength",
			PropertyType.STRING),

	HADOOP_JOB_MAP_OUTPUT_KEY_CLASS("org.apache.hadoop.job.mapOutput.keyClass",
			PropertyType.STRING),

	HADOOP_JOB_MAP_OUTPUT_VALUE_CLASS(
			"org.apache.hadoop.job.mapOutput.valueClass", PropertyType.STRING),
	...
	HADOOP_JOB_OUTPUT_VALUE_GROUPING_COMPARATOR(
			"org.apache.hadoop.job.outputValueGroupingComparator",
			PropertyType.STRING),

	HADOOP_JOB_OUTPUT_KEY_COMPARATOR_CLASS(
			"org.apache.hadoop.job.outputKeyComparatorClass",
			PropertyType.STRING),
	...
	HADOOP_JOB_TEXT_OUTPUT_FORMAT_KEY_VALUE_SEPARATOR(
			"org.apache.hadoop.job.textOutputFormat.keyValueSeparator",
			PropertyType.STRING),
	...
	HADOOP_FS_LOCAL_BLOCK_SIZE("org.apache.hadoop.fs.local.block.size",
			PropertyType.STRING),
	...
	HADOOP_INPUT_FORMAT_CLASS_PROPERTY_NAME(
			"org.ow2.proactive.scheduler.ext.mapreduce.hadoop.inputFormat.propertyName",
			PropertyType.STRING),
	 ...
	 */
	HADOOP_MAPPER_CLASS_PROPERTY_NAME(
			"org.ow2.proactive.scheduler.ext.mapreduce.hadoop.mapper.propertyName",
			PropertyType.STRING),
	...
	HADOOP_IO_FILE_BUFFER_SIZE("org.apache.hadoop.io.file.buffer.size",
			PropertyType.STRING),
	...
	HADOOP_IO_SORT_MB_PROPERTY_NAME(
			"org.ow2.proactive.scheduler.ext.mapreduce.hadoop.io.sort.mbPropertyName",
			PropertyType.STRING),
	...
	HADOOP_OUTPUT_FORMAT_CLASS_PROPERTY_NAME(
			"org.ow2.proactive.scheduler.ext.mapreduce.hadoop.outputFormat.propertyName",
			PropertyType.STRING),
	...
	HADOOP_REDUCER_CLASS_PROPERTY_NAME(
			"org.ow2.proactive.scheduler.ext.mapreduce.hadoop.reducer.propertyName",
			PropertyType.STRING);
