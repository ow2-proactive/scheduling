...
public class PAMapReduceFramework {
	...
	public static String getSpillFileName(String mapperId, String spillId) {
		return SPILL_PREFIX + FILE_NAME_CONCATENATOR + mapperId
				+ FILE_NAME_CONCATENATOR + spillId + FILE_EXTENSION_SEPARATOR
				+ SPILL_SUFFIX;
	}
	...
	public static String getMapperIntermediateFileName(String mapperId) {
		return MAPPER_INTERMEDIATE_FILE_NAME_PREFIX + FILE_NAME_CONCATENATOR
				+ mapperId + FILE_EXTENSION_SEPARATOR + SPILL_SUFFIX;
	}
	...
	public static String getMapperIntermediateIndexFileName(String mapperId) {
		return MAPPER_INTERMEDIATE_FILE_NAME_PREFIX + FILE_NAME_CONCATENATOR
				+ mapperId + FILE_EXTENSION_SEPARATOR + SPILL_INDEX_SUFFIX;
	}
	...
	public static String getReducerIntermediateFileSelector() {
		return MAPPER_INTERMEDIATE_FILE_NAME_PREFIX + FILE_NAME_CONCATENATOR
				+ ALL + FILE_EXTENSION_SEPARATOR + SPILL_SUFFIX;
	}
	...
	public static String getReducerIntermediateIndexFileSelector() {
		return MAPPER_INTERMEDIATE_FILE_NAME_PREFIX + FILE_NAME_CONCATENATOR
				+ ALL + FILE_EXTENSION_SEPARATOR + SPILL_INDEX_SUFFIX;
	}
	...
	public static String getTemporaryOutputDirectoryRegex() {
		return "_temporary" + File.separator + "_attempt_*" + File.separator
				+ "part-r-*";
	}
	...
	public static String getReducerOutputFileNamePrefix() {
		return getDefault(PAMapReduceFrameworkProperties.REDUCER_PA_TASK_OUTPUT_FILE_NAME_PREFIX
				.getKey()) + FILE_NAME_CONCATENATOR;
	}
	...
	public static FileSystem getFileSystem(
			DataSpacesFileObject dataSpacesFileObject) throws IOException {
		/*
		...
		PAHadoopJobConfiguration fakeHadoopConfiguration = new PAHadoopJobConfiguration(
				new Configuration());
