...
public class MapperJoinPATask extends JavaExecutable {
	...
	public void init(Map<String, Serializable> args) throws Exception {
		...
		outputFolderName = (String) args.get(PAMapReduceFrameworkProperties
	...
	public Serializable execute(TaskResult... taskResults) throws Throwable {
		...
		if ( ( outputFolderName != null ) && ( ! outputFolderName.trim().equalsIgnoreCase( "" ) ) ) {
			String folderToCreate = outputFolderName + File.separator + PAMapReduceFramework.FILE_NAME_CONCATENATOR + PAMapReduceFramework.TEMPORARY;
			logger.debug("The folder to create is: " + folderToCreate);
			DataSpacesFileObject folderToCreateDataSpacesFileObject = getOutputSpace().resolveFile( folderToCreate );
