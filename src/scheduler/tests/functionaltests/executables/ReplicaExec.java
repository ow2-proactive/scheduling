...
public class ReplicaExec extends JavaExecutable {
    ...
    public Serializable execute(TaskResult... results) throws Throwable {
        ...
        for (String name : new String[] { foo, bar }) {
            ...
            out.write(new String(" " + System.getProperty("foo") + " " + System.getProperty("bar") + "\n")
                    .getBytes());

            out.close();
        }

        System.out.println("hello " + getIterationIndex() + " " + getReplicationIndex());
