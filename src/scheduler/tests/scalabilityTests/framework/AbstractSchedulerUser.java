...
public abstract class AbstractSchedulerUser<V> extends ActiveActor<UserSchedulerInterface,V> {
	...
	public AbstractSchedulerUser(Action<UserSchedulerInterface,V> defaultAction,
	...
	public void connectToScheduler() throws SchedulerException, LoginException {
		SchedulerAuthenticationInterface auth =
			SchedulerConnection.join(this.schedulerURL);
	...
	public void registerListener(boolean getInitialState, boolean myEventsOnly, String listenerClazzName)
		...
		SchedulerState initialState = scheduler.addEventListener(
				schedulerListenerRemoteRef, myEventsOnly, getInitialState,
				// job-related events
	...
	protected abstract SchedulerEventListener createEventListener(String listenerClazzName) throws ClassNotFoundException, InstantiationException, IllegalAccessException;
