...
public class HelloWorldActive {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.err
                    .println("Failed to deploy the nodes from the GCM descriptor, reason:" + e.getMessage());
            System.exit(ERROR_EXIT_CODE);
        } catch (IOException e) {
            // outta here!
            System.exit(0);
    ...
    private static void printUsage() {
        ...
        System.out
                .println("\t- virtualNode is the name of the virtual node which identifies the above-mentioned nodes");
