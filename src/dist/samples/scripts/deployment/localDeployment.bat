...
set JAVA_OPTS_NODE=-Djava.security.policy=%RM_HOME_NODE%\config\security.java.policy-client -Dproactive.useIPaddress=true -Dlog4j.configuration=%RM_HOME_NODE%\config\log4j\log\node.properties
