...
public class Test {
    ...
    public static void main(String[] args) {
        if (args.length < 1) {
            System.out.println(
                "Usage: java test.locationserver.Test <destination>");
            System.exit(-1);
        }
        ...
        try {
            obj1 = (ObjectWithLocationServer) ProActive.newActive("test.locationserver.ObjectWithLocationServer",
                    null, null, null,
        ...
        try {
            test = (Test) ProActive.newActive("test.locationserver.Test", null,
                    null, null, LocationServerMetaObjectFactory.newInstance());
        } catch (Exception e) {
            e.printStackTrace();
        }
