 ...
 * Deployment is attached to a Virtual Node.
 * 
 * 
 */
@PublicAPI
public interface GCMVirtualNode {
     ...
     * 
     * The name of a Virtual Node is declared inside the GCM Application Descriptor. Each Virtual
     * Node as an unique name.
     * 
     ...
     * 
     * A Virtual Node is Ready if all Node Provider Contracts and Virtual Node capacity are
     * satisfied. Nodes can still be attached to the Virtual Node after it becomes Ready. It happens
     * if the Virtual Node is Greedy and at least one Node Provider Contract is Greedy too.
     * 
     ...
     * 
     * The method must have the following signature: <code>void method(Node, GCMVirtualNode)</code>
     * 
     * 
     * 
     * @param client
