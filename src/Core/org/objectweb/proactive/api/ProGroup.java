...
public class ProGroup {
	...
	public static Object newGroup(String className, Class[] genericParameters)
	    ...
	    try {
	    	...
	    	ProGroup.logger.error("**** ConstructionOfProxyObjectFailedException ****");
	    } catch (ConstructionOfReifiedObjectFailedException e) {
	        ProGroup.logger.error("**** ConstructionOfReifiedObjectFailedException ****");
	    }
	...
	public static Object newGroup(String className, Object[][] params,
	    ...
	    throws ClassNotFoundException, ClassNotReifiableException,
	        ActiveObjectCreationException, NodeException {
	    return newGroup(className, (Class[]) null, params,
	        nodeList);
	}
	...
	public static Object newGroupBuiltWithMultithreading(String className,
	    ...
	    return ProGroup.newGroupBuiltWithMultithreading(className,
	...
	public static Object newActiveAsGroup(String classname,
	    ...
	    if (virtualnode != null) {
	        ...
	        for (int i = 0; i < nodeTab.length; i++) {
	            Object tmp = ProActiveObject.newActive(classname, null, constructorParameters,
	...
	public static Object turnActiveAsGroup(Object target,
	    ...
	    if (virtualnode != null) {
	        ...
	        for (int i = 0; i < nodeTab.length; i++) {
	            Object tmp = ProActiveObject.turnActive(target, genericParameters,
	...
	public static Object turnActiveGroup(Object ogroup,
	    ...
	    throws ClassNotFoundException, ClassNotReifiableException,
	        ActiveObjectCreationException, NodeException {
	    return ProActiveObject.turnActive(ogroup, genericParameters,
	        getType(ogroup), NodeFactory.getNode(nodeName),
	        null, null);
	}
	...
	public static Object captureView(Object ogroup) {
	    ...
	    try {
	        result = newGroup(getType(ogroup),
	                (Class[]) null);
	    } catch (ClassNotReifiableException e) {
	    	ProGroup.logger.error("**** ClassNotReifiableException ****");
	        e.printStackTrace();
