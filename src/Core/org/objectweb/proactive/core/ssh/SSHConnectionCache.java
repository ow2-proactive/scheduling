...
public class SSHConnectionCache {
    ...
    public SSHConnection getConnection(String username, String hostname, String port) throws IOException {
        ...
        if (conn == null) {
            ...
            if (logger.isDebugEnabled()) {
                logger.debug("Connection to " + hostname + ":" + port + " already opened");
            }
        }
        return conn;
    }
