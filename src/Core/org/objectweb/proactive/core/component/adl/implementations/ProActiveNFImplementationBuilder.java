 ...
 *
 */
public interface ProActiveNFImplementationBuilder extends ImplementationBuilder {

    /**
     * Allows the creation of a ProActive non functional component on a given virtual node
