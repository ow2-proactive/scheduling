...
public class ProActiveNFContentControllerImpl
    extends AbstractProActiveController implements ProActiveContentController,
        Serializable {
    ...
    */
    ...
    public void addFcSubComponent(Component subComponent)
        ...
        if (!(subComponent instanceof ProActiveNFComponentRepresentative)) {
            throw new IllegalContentException(
                "Only non-functional components should be added to a non-functional composite");
        }
    ...
    public void addFcSubComponent(List<Component> subComponents)
        ...
        for (Iterator<Component> iter = subComponents.iterator();
            ...
            AddNFSubComponentTask task = new AddNFSubComponentTask(e, this,
                    element);
    ...
    public void removeFcSubComponent(List<Component> subComponents)
        ...
        for (Iterator<Component> iter = subComponents.iterator();
                iter.hasNext();) {
            Component element = iter.next();
            RemoveNFSubComponentTask task = new RemoveNFSubComponentTask(e,
                    this, element);
            threadPool.execute(task);
        }
        threadPool.shutdown();
    ...
    private static class AddNFSubComponentTask implements Runnable {
        ContentControllerExceptionListException exceptions;
        ProActiveNFContentControllerImpl controller;
        Component component;

        public AddNFSubComponentTask(
            ContentControllerExceptionListException exceptions,
            ProActiveNFContentControllerImpl impl, Component component) {
    ...
    private static class RemoveNFSubComponentTask implements Runnable {
        ContentControllerExceptionListException exceptions;
        ProActiveNFContentControllerImpl controller;
        Component component;

        public RemoveNFSubComponentTask(
            ContentControllerExceptionListException exceptions,
            ProActiveNFContentControllerImpl controller, Component component) {
            this.exceptions = exceptions;
