...
Serializable, P2PConstants, ProActiveInternalObject {
	...
	static public  int NOA = Integer.parseInt(System.getProperty("proactive.p2p.noa"));
		...
		while (it.hasNext() &&
			...
			try {
				...
				if (//!peer.equals(this.localService) &&
					...
					System.out.println("P2PAcquaintanceManager requesting peer " +
							peerUrl);
