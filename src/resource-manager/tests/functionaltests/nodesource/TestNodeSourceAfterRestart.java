...
public class TestNodeSourceAfterRestart extends FunctionalTest {
    ...
    private void startRMPreservingDB() throws Exception {
        String rmconf = new File(PAResourceManagerProperties
                .getAbsolutePath("src/resource-manager/tests/functionaltests/config/rm-with-db.ini"))
                .getAbsolutePath();
        RMTHelper.getDefaultInstance().startRM(rmconf, CentralPAPropertyRepository.PA_RMI_PORT.getValue());
