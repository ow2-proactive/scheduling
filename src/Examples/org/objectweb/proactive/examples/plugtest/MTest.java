...
public class MTest {
    public static void main(String[] args) {
        try {
            ...
            ObjB b = (ObjB) org.objectweb.proactive.api.ProActiveObject.newActive(ObjB.class.getName(),
                    new Object[] { "B" });

            for (int i = 0; i < noeuds.length; i++) {
                arrayA[i] = (ObjA) org.objectweb.proactive.api.ProActiveObject.newActive(ObjA.class.getName(),
