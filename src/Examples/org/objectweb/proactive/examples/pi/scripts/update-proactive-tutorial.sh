...
scp -i $SOPHIA_CLUSTER_KEY $PROACTIVE/lib/jsch.jar mmorel@cluster.inria.fr:~/tutorial/libs/
...
scp -i $AMSTERDAM_CLUSTER_KEY $PROACTIVE/lib/jsch.jar rquilici@fs0.das2.cs.vu.nl:~/tutorial/libs/
