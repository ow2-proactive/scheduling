...
public class ListPackages {
    public static void main(String[] arg) throws java.io.IOException {
        java.io.File sourceDir = new java.io.File(
                "D:\\cygwin\\home\\lmestre\\ProActive\\src");
        java.io.File targetDir = new java.io.File("org\\objectweb\\proactive");
        java.io.File destFile = new java.io.File(sourceDir,
                "..\\compile\\packages.txt");
        java.io.Writer out = new java.io.BufferedWriter(new java.io.PrintWriter(
                    new java.io.FileOutputStream(destFile), false));
        listPackages(sourceDir, targetDir, out);
        out.flush();
        out.close();
    }

    private static void listPackages(java.io.File baseDir,
        java.io.File targetDir, java.io.Writer out) throws java.io.IOException {
        ...
        for (int i = 0; i < listFiles.length; i++) {
            ...
            if (fileItem.isDirectory() && acceptDirectory(fileItem.getName())) {
                java.io.File currentDir = new java.io.File(targetDir,
                        fileItem.getName());
    ...
    private static boolean acceptDirectory(String dirName) {
        if (dirName.indexOf("CVS") > -1) {
            return false;
        }
        if (dirName.indexOf("doc-files") > -1) {
            return false;
        }
        if (dirName.indexOf("images") > -1) {
            return false;
        }
        if (dirName.indexOf("examples") > -1) {
            return false;
        }
        if (dirName.indexOf("security") > -1) {
            return false;
        }
        if (dirName.indexOf("ic2d") > -1) {
            return false;
        }
        return true;
    }
