...
public class SimpleAgent implements Active, Serializable {
  ...
  public void synchroneRequestOnAgent(AgentForThread a) {
    String t;
    //	System.out.println("SimpleAgent: now calling synchrone request");
    ...
    if (t == null)
      ...
      System.out.println("SimpleAgent: We got the following result: " + t);
  }


  public void echo() {
    System.out.println("I am on host " + this.whereAreYou());
