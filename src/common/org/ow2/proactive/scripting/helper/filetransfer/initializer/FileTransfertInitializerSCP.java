...
public class FileTransfertInitializerSCP implements FileTransfertInitializer {
	...
	public FileTransfertInitializerSCP(String host, String user, String pass, Class<? extends FileTransfertDriver> driver){
		_host = host;
		_user = user;
		_pass = pass;
		_driverClass = driver;
	...
	public FileTransfertInitializerSCP(String host, String user, String pass, int port, Class<? extends FileTransfertDriver> driver){
