...
public class SFTP_Trilead_Driver implements FileTransfertDriver {
	...
	public void putFile(String localFilePath, String remoteFolder, boolean ownConnection)
		throws Exception {
	...
	public void putFiles(List<String> localFilePaths, String remoteFolder)
         ...
         */
	 	private  void createRemoteDirs(String path) throws IOException, AuthentificationFailedException, NotConnectedException {
