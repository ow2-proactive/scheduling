...
import org.objectweb.proactive.extra.resourcemanager.core.RMCoreSourceInt;
 ...
 * NodeSource communications to IMCore are defined in {@link org.objectweb.proactive.extra.resourcemanager.core.RMCoreSourceInt}.<BR><BR><BR>
 *
 *
 ...
 * {@link org.objectweb.proactive.extra.resourcemanager.nodesource.frontend.NodeSource#addNewAvailableNode(Node,String,String)}
 * (method to call when a new node is available).<BR>
 * The NodeSource add node to the {@link RMCoreSourceInt} with the method<BR>
 * {@link org.objectweb.proactive.extra.resourcemanager.core.RMCoreSourceInt#internalAddNode(Node, String, String, NodeSource)}<BR><BR>
 *
 * 2- NodeSource ask to remove the Node to the {@link RMCoreSourceInt} with the method : <BR>
 * {@link org.objectweb.proactive.extra.resourcemanager.core.RMCoreSourceInt#internalRemoveNode(String, boolean)}<BR><BR>
 *
 * 3- Finally the {@link RMCore} confirm the removing request by calling <BR>
 * {@link org.objectweb.proactive.extra.resourcemanager.nodesource.frontend.NodeSource#confirmRemoveNode(String)} <BR><BR>
 *
 *
 ...
 *                 {@link org.objectweb.proactive.extra.resourcemanager.nodesource.frontend.NodeSource#addNodes(ProActiveDescriptor, String)}<BR>
 * - {@link RMCore} receive a removing node request, it just forwards the request to the appropriate NodeSource by calling :<BR>
 *                 {@link org.objectweb.proactive.extra.resourcemanager.nodesource.frontend.NodeSource#forwardRemoveNode(String, boolean)}.
 ...
 * (call @see org.objectweb.proactive.extra.resourcemanager.nodesource.frontend.NodeSource#detectedPingedDownNode(String);).
 *
 *
 *        @see RMCoreSourceInt
 *        @see RMCore
...
public abstract class NodeSource implements Serializable, InitActive, EndActive {
     ...
     * @see org.objectweb.proactive.extra.resourcemanager.nodesource.frontend.NodeSource
     *
     */
