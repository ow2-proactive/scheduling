...
public class NFEHandler implements  NFEListener,java.io.Serializable
{
	...
	public boolean handleNFE(NonFunctionalException e) {
		...
		logger.debug("follows is a print out of the stack trace, warning, hte exception is caught , this is just a printout"+ProActiveLogger.getStackTraceAsString(e));
		return true;
	}
