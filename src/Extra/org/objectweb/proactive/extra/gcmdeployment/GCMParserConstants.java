...
public interface GCMParserConstants {
    ...
    public static final String VARIABLES_DESCRIPTOR = GCM_DESCRIPTOR_NAMESPACE_PREFIX + VARIABLES_DESCRIPTOR_TAG;
    public static final String VARIABLES_PROGRAM = GCM_DESCRIPTOR_NAMESPACE_PREFIX + VARIABLES_PROGRAM_TAG;
    public static final String VARIABLES_DESCRIPTOR_DEFAULT = GCM_DESCRIPTOR_NAMESPACE_PREFIX + VARIABLES_DESCRIPTOR_DEFAULT_TAG;
    public static final String VARIABLES_PROGRAM_DEFAULT = GCM_DESCRIPTOR_NAMESPACE_PREFIX + VARIABLES_PROGRAM_DEFAULT_TAG;
    public static final String VARIABLES_JAVAPROPERTY = GCM_DESCRIPTOR_NAMESPACE_PREFIX + VARIABLES_JAVAPROPERTY_TAG;
    public static final String VARIABLES_JAVAPROPERTY_DESCRIPTOR = GCM_DESCRIPTOR_NAMESPACE_PREFIX + VARIABLES_JAVAPROPERTY_DESCRIPTOR_TAG;
    public static final String VARIABLES_JAVAPROPERTY_PROGRAM = GCM_DESCRIPTOR_NAMESPACE_PREFIX + VARIABLES_JAVAPROPERTY_PROGRAM_TAG;
    public static final String VARIABLES_INCLUDE_XML_FILE = GCM_DESCRIPTOR_NAMESPACE_PREFIX + VARIABLES_INCLUDE_XML_FILE_TAG;
    public static final String VARIABLES_INCLUDE_PROPERTY_FILE = GCM_DESCRIPTOR_NAMESPACE_PREFIX + VARIABLES_INCLUDE_PROPERTY_FILE_TAG;
