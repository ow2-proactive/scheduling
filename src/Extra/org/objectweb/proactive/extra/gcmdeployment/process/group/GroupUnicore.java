...
public class GroupUnicore extends AbstractGroup {
    ...
    public class UnicoreParameters implements java.io.Serializable {
        ...
        private PathElement unicoreDir;
        private PathElement keyFilePath;
         ...
         */
        public PathElement getKeyFilePath() {
            return keyFilePath;
        }

        /**
         * @param path The keyFilePath to set.
         */
        public void setKeyFilePath(PathElement path) {
         ...
         */
        public PathElement getUnicoreDir() {
            return unicoreDir;
        }
         ...
         */
        public void setUnicoreDir(PathElement unicoreDir) {
        ...
        public void addDeploymentFile(String f) {
            ...
            if (info.length != 2) {
                System.err.println(
                    "Skipping file, syntax error on file parameter:" + f);
                return;
            }
        ...
        public void setParameter(String name, String value) {
            ...
            if (name.equalsIgnoreCase("jobname")) {
                ...
                setUnicoreDir(new PathElement(value));
            } else if (name.equalsIgnoreCase("keyfilepath")) {
                setKeyFilePath(new PathElement(value));
        ...
        public String getCommandString(HostInfo hostInfo,
            ...
            sb.append("-submitjob ").append(submitJob).append(" ");
            sb.append("-saveJob ").append(saveJob).append(" ");
            sb.append("-unicoreDir ")
              .append(quoteIfNeeded(unicoreDir.getFullPath(hostInfo,
                        commandBuilder))).append(" ");
            sb.append("-keyFilePath ")
              .append(quoteIfNeeded(keyFilePath.getFullPath(hostInfo,
                        commandBuilder))).append(" ");
        ...
        public UnicoreParameters() {
            ...
            unicoreDir = new PathElement(".unicore", PathElement.PathBase.HOME);
            keyFilePath = new PathElement(unicoreDir.getRelPath() +
                    File.separator + "keystore", PathElement.PathBase.HOME);
