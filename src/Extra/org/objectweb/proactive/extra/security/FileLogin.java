...
public abstract class FileLogin {
    ...
    /**
     * Test implementation of the Login standard interface. Uses the
     * <code>TestLoginMethod</code> from the configuration file designated by
     * the "java.security.auth.login.config" system property, which must be set
     * to use the <code>TestLoginModule</code> in this package. It will only
