...
public class StartP2P {
    ...
    public void startP2PNetworkWithPAD(String proActiveDescriptor) {
        ...
        try {
            System.out.println("같같같같같같같같같같같같같캳tarting Entry Node같같같같같같같같같같같같같�");
            ...
            System.out
                    .println("같같같같같같같같같같같같같캳tarting Others Entry Nodes같같같같같같같같같같같같같�");
            ...
            for (Node node : vn2.getNodes()) {
                ...
                System.out
                        .println("같같같같같같같같같같같같같캳tarting Others Nodes같같같같같같같같같같같같같�");
                P2PLauncher p2pLauncher = (P2PLauncher) PAActiveObject.newActive(P2PLauncher.class.getName(),
