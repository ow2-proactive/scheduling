 ...
 * As the {@link IMCore} manage nodes providing to Scheduler (with nodes selection, and nodes states handling),
 * a NodeSource has just to : acquire nodes, add them to {@link IMCore}, monitor these acquired nodes,
 * and finally remove them from IMCore.
 * NodeSource communications to IMCore are defined in {@link org.objectweb.proactive.extra.infrastructuremanager.core.IMCoreSourceInt}.<BR><BR><BR>
 *
 *
 * There is a mechanism of giving-removing nodes between NodeSource and {@link IMCore} :<BR><BR>
 *
 ...
 * The NodeSource add node to the {@link IMCoreSourceInt} with the method<BR>
 ...
 *
 * 2- NodeSource ask to remove the Node to the {@link IMCoreSourceInt} with the method : <BR>
 ...
 *                 {@link org.objectweb.proactive.extra.infrastructuremanager.nodesource.frontend.NodeSource#forwardRemoveNode(String, boolean)}.
 ...
 * (call @see org.objectweb.proactive.extra.infrastructuremanager.nodesource.frontend.NodeSource#detectedPingedDownNode(String);).
 *
 *
 *        @see IMCoreSourceInt
 *        @see IMCore
...
public abstract class NodeSource implements Serializable, InitActive, EndActive {
    ...
    /** {@link IMCore} interface for the NodeSource */
     ...
     * <BR>Called by {@link IMCore}.<BR>
     * {@link IMAdmin} asked an explicit removing node request to {@link IMCore}.<BR>
     ...
     * NodeSource has asked previously a remove of a node to {@link IMCore}, by
     * the {@link IMCore#internalRemoveNode(String, boolean)} method.<BR>
