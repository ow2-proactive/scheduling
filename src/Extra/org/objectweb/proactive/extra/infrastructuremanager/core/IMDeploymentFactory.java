...
public class IMDeploymentFactory {
	 ...
	 */
	public static void deployAllVirtualNodes(IMCore imCore, String padName, ProActiveDescriptor pad) {
    ...
    public static void deployVirtualNode(IMCore imCore, String padName, ProActiveDescriptor pad, String vnName) {
    	if (logger.isInfoEnabled()) {
    ...
    public static void deployVirtualNodes(IMCore imCore, String padName, ProActiveDescriptor pad, String[] vnNames) {
    	if (logger.isInfoEnabled()) {
