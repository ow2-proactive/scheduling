...
public class TestLogger {
	...
	public static void main(String[] args ){
		...
		if(logger.isInfoEnabled())  { logger.info("Info mode actif"); 	}
		if(logger.isDebugEnabled()) { logger.debug("Debug mode actif"); }
		
		if(loggerTest.isInfoEnabled())  { loggerTest.info("Test Info mode actif"); 	}
		if(loggerTest.isDebugEnabled()) { loggerTest.debug("Test Debug mode actif"); }
