...
import org.objectweb.proactive.extra.taskscheduler.policy.GenericPolicy;
    ...
    public void configureScheduler() throws Exception {
        try {
            SCHEDULER_TIMEOUT = Long.parseLong(System.getProperty(
                        "proactive.taskscheduler.scheduler_timeout"));

            TIME_BEFORE_TEST_ALIVE = Long.parseLong(System.getProperty(
                        "proactive.taskscheduler.time_before_test_alive"));
