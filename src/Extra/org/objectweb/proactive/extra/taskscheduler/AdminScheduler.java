...
import org.objectweb.proactive.extra.taskscheduler.exception.AdminException;
    ...
    public static AdminScheduler createLocalScheduler(
        ...
        try {
            defaultPolicy = System.getProperty(
                    "proactive.taskscheduler.default_policy");
            defaultFactory = System.getProperty(
                    "proactive.taskscheduler.default_policy_factory");
        } catch (Exception e) {
            logger.error(
