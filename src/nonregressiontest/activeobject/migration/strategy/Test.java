...
public class Test extends ProActiveFunctionalTest {
    ...
    public void action() throws Exception {
        ...
        nodesUrl[0] = ((ProActiveFuncTestManager) manager).getLocalVMNode()
                       .getNodeInformation().getURL();
        nodesUrl[1] = ((ProActiveFuncTestManager) manager).getSameVMNode()
                       .getNodeInformation().getURL();
        nodesUrl[2] = ((ProActiveFuncTestManager) manager).getRemoteVMNode()
                       .getNodeInformation().getURL();
