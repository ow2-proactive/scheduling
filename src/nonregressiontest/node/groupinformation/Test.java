 ...
 * ################################################################
 */
package nonregressiontest.node.groupinformation;
...
public class Test extends FunctionalTest {
    ...
    static {
        String value = System.getProperty(
                "nonregressiontest.node.groupinformation.file");
        if (value != null) {
            XML_LOCATION = Test.class.getResource(value).getPath();
        } else {
            XML_LOCATION = Test.class.getResource(
                    "/nonregressiontest/node/groupinformation/groupinformation.xml")
                                     .getPath();
        }
    }
