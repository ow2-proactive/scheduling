...
public class Test extends FunctionalTest {
	...
	public Test() {
		super("scatter parameters", "distributes the parameters of a method call to member");
	}
	...
	public boolean postConditions() throws Exception {
		...
		for (int i = 0 ; i < group.size() ; i++) {
			rightRankingAndCorrectnessOfResults &=
				((A) groupResult.get(i)).getName().equals((((A) group.get(i)).asynchronousCall((A) groupParameter.get(i))).getName());
		}
