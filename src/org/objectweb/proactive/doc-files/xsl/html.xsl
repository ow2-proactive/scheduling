					...
					<td>
						<img>
							<xsl:attribute name="src">
								<xsl:copy-of
									select="$threeinstitutes.image.filename" />
							</xsl:attribute>
							<xsl:attribute name="alt">
								A CNRS-INRIA-UNSA Research team
							</xsl:attribute>
					...
					<td>
						<a href="http://www.objectweb.org">
							<img>
								<xsl:attribute name="src">
									<xsl:copy-of
										select="$objectweb.image.filename" />
								</xsl:attribute>
								<xsl:attribute name="alt">
									ObjectWeb
								</xsl:attribute>
								<xsl:attribute name="title">
									A project of the ObjectWeb Consortium
								</xsl:attribute>
							</img>
						</a>
					</td>
		...
		<table>
			<tbody>
				<tr>
					<td>
						<xsl:apply-templates
							mode="book.titlepage.recto.mode" select="bookinfo/subtitle" />
					</td>
				</tr>
			</tbody>
		</table>
				...
				<tr>
					<td>
						...
						<xsl:apply-templates
							...
							select="bookinfo/revision/revnumber" />
					</td>
					<td>
						<xsl:apply-templates
							mode="book.titlepage.recto.mode" select="bookinfo/revision/date" />
					</td>
					<td>
						<xsl:apply-templates
