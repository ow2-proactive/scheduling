...
public class Line2dChart implements Chart {
    ...
    public void generateChart(Element eTimit, BenchmarkStatistics bstats,
        ...
        while(true ) {
            Iterator<Element> it =
                eTimitClone.getDescendants(new ElementFilter(cChart.get("tag")));
            try {
                while (it.hasNext()) {
        ...
        this.wantedTag =
            ((Element) this.series[0].getChildren().get(0)).getName();
    ...
    private CategoryDataset createDataset() {
        ...
        Element currentElement, iteratedElement;
        Iterator it;
        String currentTagName, attributeNameValue, stringValue;
        double value;
