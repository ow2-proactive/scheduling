...
public class ActiveDisplay implements ConsumerProducerListener {
  ...
  public void start() {
    ...
    try {
      buffer = (BoundedBuffer)org.objectweb.proactive.ProActive.newActive(BoundedBuffer.class.getName(), new Object[]{new Integer(size), o});
    } catch (Exception e) {
    }
    ...
    try {
      producer = (Producer)org.objectweb.proactive.ProActive.newActive(Producer.class.getName(), new Object[]{o, buffer});
    } catch (Exception e) {
    }
    ...
    try {
      consumer = (Consumer)org.objectweb.proactive.ProActive.newActive(Consumer.class.getName(), new Object[]{o, buffer});
    } catch (Exception e) {
    }
