...
public class TreeApplet extends org.objectweb.proactive.examples.StandardFrame {
	...
	search.addActionListener(new java.awt.event.ActionListener() {
		...
		try {
			...
			res.add(new String[]{(String) (keys.get(((Integer)vKeys.remove(key)).intValue())), ((ObjectWrapper) tab1.get(key)).toString(), "" + i});
			tab1.remove(key);
		    }
	...
	public void paintTree(java.awt.Graphics g, Tree tree, int x, int y, int depth) {
		...
		java.text.StringCharacterIterator it1
		    = new java.text.StringCharacterIterator(tree.getKey());
		...
		int valueSize = 5;
		java.text.StringCharacterIterator it2
		    = new java.text.StringCharacterIterator(tree.getValue());
