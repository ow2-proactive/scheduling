...
public class ImageCanvas extends Canvas {
    ...
    public ImageCanvas(int imageWidth, int imageHeight) {
        ...
        display = new BufferedImage(my_WIDTH, my_HEIGHT, BufferedImage.TYPE_INT_RGB);
    ...
    public void setPixels(Image2D image) {
        ...
        display.setRGB(
                0, interval.yfrom, interval.totalImageWidth, interval.yto - interval.yfrom,
                image.getPixels(), 0, interval.totalImageWidth);
        repaint();
    }
