...
public abstract class DispatcherGUI implements ActionListener {
    ...
    private JComponent createInfoText() {
        ...
        Label machine = new Label(
                "on " + localhostName + " (" + System.getProperty("os.name") + ")" , Label.CENTER);
        ...
        box.add(machine);
        infoPanel.add(box);
        infoPanel.setMaximumSize(new Dimension(Integer.MAX_VALUE, header.getSize().height + machine.getSize().height ));
        return infoPanel;
    }
