...
public class Matrix implements java.io.Serializable {
  ...
  public /*synchronized*/ void rowLC(int firstrow, int secondrow, double alpha, double beta) {
    ...
    for (j = 0; j < this.n; j++) {
      this.setElement(firstrow, j, alpha * this.getElement(firstrow, j) + beta * this.getElement(secondrow, j));
    }
    return;
  }
  ...
  public /*synchronized*/ void columnLC(int firstcol, int secondcol, double alpha, double beta) {
    ...
    for (i = 0; i < this.m; i++) {
      this.setElement(i, firstcol, alpha * this.getElement(i, firstcol) + beta * this.getElement(i, secondcol));
    }
    return;
  }
