...
public class TestFutureList {
  ...
  public static void main(String[] args) {
    ...
    try {
      blockedO = (BlockedObject)org.objectweb.proactive.ProActive.newActive(BlockedObject.class.getName(), null, args[0]);
      tf = (FutureReceiver)org.objectweb.proactive.ProActive.newActive(FutureReceiver.class.getName(), null, args[1]);
    } catch (Exception e) {
      e.printStackTrace();
    }
