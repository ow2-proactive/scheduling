...
// TODO Z7 Info is a bad class name!
public class Info implements Serializable{
    ...
    public Info(Vector planetVector, Rectangle bounds){
        ...
        Planet [] planets = new Planet[planetVector.size()];		// TODO Z9 why doesn't toArray() work?
    ...
    public void setCenterOfMass(Info[] planets) {
        ...
        if (mass == 0 ) {
            System.out.println ("Divide by zero . Planets : " + planets.length );
            System.exit (-2);
        }
