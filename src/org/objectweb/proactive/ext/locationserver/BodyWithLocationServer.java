...
public class BodyWithLocationServer extends BodyImpl {
  ...
  public BodyWithLocationServer(ConstructorCall c, String nodeURL) throws InvocationTargetException, org.objectweb.proactive.core.mop.ConstructorCallExecutionFailedException {
    super(c, nodeURL);
  }
 ...
 //   public void setServer(LocationServer s) {
//      System.out.println("BodyWithLocationServer: setServer() setting to server " + s);
//      this.locationserver = s;
//    }


//   public LocationServer getServer() {
//     System.out.println("BodyWithLocationServer: getServer() returning " + ((MigrationManagerWithLocationServer)migrationManager).locationServer);
//     return ((MigrationManagerWithLocationServer)migrationManager).locationServer;
//   }
