...
public class MigrationStrategyManagerImpl implements MigrationStrategyManager, MigrationEventListener, java.io.Serializable {
  ...
  protected void executeMethodOnDeparture(Body body) throws MigrationException {
    if (methodOnDeparture == null) return;
    //NE PAS SUPPRIMER!!!
  ...
  protected void executeMethodOnArrival(Body body) throws MigrationException {
    if (methodOnArrival == null) return;
  ...
  private void executeMethod(Object target, String methodName) throws MigrationException {
    try {
      ...
      throw new MigrationException("Cannot find method "+methodName+" in class "+target.getClass().getName(),e);
    } catch (IllegalAccessException e) {
      throw new MigrationException("Cannot access method "+methodName+" in class "+target.getClass().getName(),e);
