 ...
 * <br>
 * use<br>
 * &nbsp;&nbsp;&nbsp;java org.objectweb.proactive.rmi.StartNode<br>
...
public class StartNode {
   ...
   * usage: java org.objectweb.proactive.rmi.StartNode &lt;node URL> [options]<br>
  ...
  /**
   * <i><font size="-1" color="#FF0000">**For internal use only** </font></i>
   * Associates the RMI node factory to the RMI protocol
   */
  protected void setNodeFactory() throws java.io.IOException, NodeException {
    NodeFactory.setFactory(org.objectweb.proactive.core.Constants.RMI_PROTOCOL_IDENTIFIER, "org.objectweb.proactive.core.node.rmi.RemoteNodeFactory");
  }
  ...
  protected void createNode(String nodeURL, boolean noRebind) throws NodeException {
    ...
    while (true) {
      try {
        ...
        System.out.println("OK. Node "+node.getNodeInformation().getName()+" created in VM id=" + UniqueID.getCurrentVMID());
        break;
  ...
  protected void run() throws java.io.IOException, NodeException {
    ...
    RemoteNodeFactory.setClassServerClasspath(classpath);
    if (noClassServer) RemoteNodeFactory.setShouldCreateClassServer(false);
    if (noRegistry) RemoteNodeFactory.setShouldCreateRegistry(false);
  ...
  private void printUsage() {
    ...
    System.out.println("  for instance: java "+StartNode.class.getName()+" //localhost/node1");
    System.out.println("                java "+StartNode.class.getName()+" //localhost/node2 -noClassServer -noRebind");
  }
