...
public abstract class AbstractDataObject implements MessageMonitoringController {
  ...
  protected AbstractDataObject(AbstractDataObject parent, String abstractDataObjectName) {
    this();
    this.parent = parent;
    ...
    else this.abstractDataObjectName = abstractDataObjectName;  
  ...
  public void monitorRequestReceiver(boolean shouldMonitor) {
    ...
    if (monitoringRequestReceiver != shouldMonitor) {
      ...
      if (messageMonitoringListener != null) messageMonitoringListener.monitoringRequestReceiverChanged(shouldMonitor);
    }
  ...
  public void monitorRequestSender(boolean shouldMonitor) {
    ...
    if (monitoringRequestSender != shouldMonitor) {
      ...
      if (messageMonitoringListener != null) messageMonitoringListener.monitoringRequestSenderChanged(shouldMonitor);
    }
  ...
  public void monitorReplyReceiver(boolean shouldMonitor) {
    ...
    if (monitoringReplyReceiver != shouldMonitor) {
      ...
      if (messageMonitoringListener != null) messageMonitoringListener.monitoringReplyReceiverChanged(shouldMonitor);
    }
  ...
  public void monitorReplySender(boolean shouldMonitor) {
    ...
    if (monitoringReplySender != shouldMonitor) {
      ...
      if (messageMonitoringListener != null) messageMonitoringListener.monitoringReplySenderChanged(shouldMonitor);
    }
  ...
  */
   ...
   * @param iterator an iterator on the collection of object to notify
   */
  protected synchronized void monitorRequestReceiverCollection(boolean shouldMonitor, java.util.Iterator iterator) {
    while (iterator.hasNext() && ! isDestroyed) {
      MessageMonitoringController o = (MessageMonitoringController) iterator.next();
   ...
   * @param iterator an iterator on the collection of object to notify
   */
  protected synchronized void monitorRequestSenderCollection(boolean shouldMonitor, java.util.Iterator iterator) {
    while (iterator.hasNext() && ! isDestroyed) {
      MessageMonitoringController o = (MessageMonitoringController) iterator.next();
   ...
   * @param iterator an iterator on the collection of object to notify
   */
  protected synchronized void monitorReplyReceiverCollection(boolean shouldMonitor, java.util.Iterator iterator) {
    while (iterator.hasNext() && ! isDestroyed) {
      MessageMonitoringController o = (MessageMonitoringController) iterator.next();
   ...
   * @param iterator an iterator on the collection of object to notify
   */
  protected synchronized void monitorReplySenderCollection(boolean shouldMonitor, java.util.Iterator iterator) {
    while (iterator.hasNext() && ! isDestroyed) {
      MessageMonitoringController o = (MessageMonitoringController) iterator.next();
   ...
   * @param iterator an iterator on the collection of object to notify
   */
  protected synchronized void monitorAllCollection(boolean shouldMonitor, java.util.Iterator iterator) {
    while (iterator.hasNext() && ! isDestroyed) {
      MessageMonitoringController o = (MessageMonitoringController) iterator.next();
  ...
  protected void monitoringMessageEventChanged(ActiveObject object, boolean value) {
    if (parent != null && ! isDestroyed) parent.monitoringMessageEventChanged(object, value);
  }
