...
public class NodeObject extends AbstractDataObject {
  ...
  public NodeObject(VMObject parent, Node node) {
    super(parent);
    this.node = node;
    controller.log("Node Object "+node.getNodeInformation().getURL()+" created.");
  }
  ...
  public Object createNewRemoteObject(String classname) {
    try {
      ...
      controller.log("Active Object "+classname+" succesfully created.");
      return o;
  ...
  public ActiveObject addActiveObject(String classname, UniqueID bodyID, boolean isActive) {
