...
public class WorldObject extends AbstractDataObject {
  ...
  public HostObject addHostObject(String hostname, String nodeName) throws java.rmi.RemoteException {
    ...
    if (host == null) {
      ...
      controller.log("Hostname "+hostname+ " already monitored, check for new nodes.");
    }
    if (nodeName == null) {
      host.createAllNodes();
    } else {
  ...
  public void addHosts(){
    RunnableProcessor.getInstance().processRunnable("Create Jini nodes", new CreateJiniNodeTask(this), controller);
  }
  
  public void addHosts(String host){
    RunnableProcessor.getInstance().processRunnable("Create Jini nodes", new CreateJiniNodeTask(this, host), controller);
  }
  ...
  public void removeHostObject(String hostname) {
    ...
    if (host != null) {
      if (listener != null) listener.hostObjectRemoved(host);
    }
  }
