...
public class JVMProcessWrapper {
    ...
    // -- CONSTRUCTORS -----------------------------------------------
    //
    public JVMProcessWrapper(UniversalProcess process,
        MessagePanel messagePanel, String javaPath, String policyFile,
        String classpath, String classname, String parameters) {
        this(process, messagePanel, javaPath, policyFile, classpath, classname,
            parameters, null, null);
    }

    public JVMProcessWrapper(UniversalProcess process,
        MessagePanel messagePanel, String javaPath, String policyFile,
        String classpath, String classname, String parameters, String hostname,
        String username) {
