...
public class NodePanel extends AbstractDataObjectPanel implements NodeObjectListener {
  ...
  private static javax.swing.border.Border STANDARD_LINE_BORDER =
    javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 128, 128));
  private static javax.swing.border.Border ACCEPT_LINE_BORDER =
    javax.swing.BorderFactory.createLineBorder(java.awt.Color.green);
  private static javax.swing.border.Border ACCEPTED_LINE_BORDER =
    javax.swing.BorderFactory.createLineBorder(java.awt.Color.red);
  private static javax.swing.border.Border MARGIN_EMPTY_BORDER =
    javax.swing.BorderFactory.createEmptyBorder(4, 4, 4, 3);
  ...
  private void invokeMigrateTo(final ActiveObject activeObject, final String destURL) {
    new Thread(new Runnable() {
        public void run() {
          boolean b = activeObject.migrateTo(destURL);
          if (! b) {
            ActiveObjectPanel activeObjectPanel = getTopLevelParent().findActiveObjectPanelByActiveObject(activeObject);
