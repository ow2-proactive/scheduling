...
public abstract class AbstractDataObjectPanel extends javax.swing.JPanel implements MessageMonitoringListener {
  ...
  protected StatefullMessageMonitoringMenu monitoringMenu;
  ...
  public AbstractDataObjectPanel(java.awt.Frame parentFrame, ActiveObjectFilter activeObjectFilter, IC2DGUIController controller, ActiveObjectWatcher activeObjectWatcher, String name, String type) {
    this(name, type);
  ...
  protected void filterChangeParentNotification() {
   if (parentDataObjectPanel != null)
     parentDataObjectPanel.filterChangeParentNotification();
  }
 ...
 protected synchronized ActiveObjectPanel findActiveObjectPanelByActiveObject(ActiveObject activeObject) {
   ...
   while (iterator.hasNext()) {
     ...
     if (activeObjectPanel != null) return activeObjectPanel;
   }
   return null;
 }
  ...
  */
  ...
  protected synchronized void addActiveObjectToWatcher() {
    java.util.Iterator iterator = childsIterator();
    while (iterator.hasNext()) {
      AbstractDataObjectPanel o = (AbstractDataObjectPanel) iterator.next();
      o.addActiveObjectToWatcher();
    }
  }
  
  protected synchronized void removeActiveObjectFromWatcher() {
    java.util.Iterator iterator = childsIterator();
    while (iterator.hasNext()) {
      AbstractDataObjectPanel o = (AbstractDataObjectPanel) iterator.next();
      o.removeActiveObjectFromWatcher();
    }
  }
  ...
  protected class PanelPopupMenu extends javax.swing.JPopupMenu {
    ...
    public PanelPopupMenu(String name) {
      ...
      monitoringMenu = new StatefullMessageMonitoringMenu("Monitor events", getAbstractDataObject());
      add(monitoringMenu);
...
} // end class AbstractDataObjectPanel