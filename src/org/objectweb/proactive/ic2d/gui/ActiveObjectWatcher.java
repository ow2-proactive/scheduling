...
/**
 * An object implementing this interface is able to watch some ActiveObject in order to monitor
 * their state partially or fully and to display it in some from
 */
public interface ActiveObjectWatcher {
