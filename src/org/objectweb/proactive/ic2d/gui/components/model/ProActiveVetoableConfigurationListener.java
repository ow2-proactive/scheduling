 ...
 *
 */
public interface ProActiveVetoableConfigurationListener
    extends VetoableConfigurationListener {
    void canChangeVirtualNode(Component component, String virtualNode);

    void canChangeExportedVirtualNode(ProActiveComponent component,
