 ...
 *
 */
public class ProActiveDialogController extends BasicDialogController
    implements ProActiveDialogViewListener {
    public void addExportedVirtualNodesCompositionButtonClicked() {
        ...
        if ((component.getCurrentlyEditedExportedVirtualNodeName() != null) &&
                (component.getCurrentlyEditedComposingVirtualNodesNames() != null)) {
            component.addExportedVirtualNode(component.getCurrentlyEditedExportedVirtualNodeName(),
                component.getCurrentlyEditedComposingVirtualNodesNames());
