...
public class PlayerFrameTimeLine extends javax.swing.JFrame {
    ...
    public PlayerFrameTimeLine(EventListsPanel eventListsPanel,
        ...
        this.threadPlayer = new ThreadPlayer(eventListsPanel,
    ...
    private void createListenerButtons(javax.swing.JToolBar tools) {
        ...
        monitoringControlButton.setToolTipText(
            "Disable the monitoring of events to allow the play back");
