...
public class ActiveObjectCommunicationRecorder {
  ...
  public void recordCommunication(ActiveObjectPanel source, ActiveObjectPanel dest) {
  ...
  public void setDrawingStyle(int drawingStyle) {
    switch (drawingStyle) {
      ...
      case FILAIRE_DRAWING_STYLE:
        ...
        break;
      default:
        throw new IllegalArgumentException("The number passed is not a known drawing style");
    }
  }
  ...
  public void drawAllLinks(java.awt.Graphics g, java.awt.Point topLeftCornerScreenCoordinate) {
    ...
    java.util.Iterator sourceEntryIterator = panelToPanelsMap.entrySet().iterator();
    ...
    synchronized (panelToPanelsMap) {
      while (sourceEntryIterator.hasNext()) {
        ...
        synchronized(destMap) {
          drawOneSourceLinks(destEntryIterator, g2, topLeftCornerScreenCoordinate, oldStroke, ratio, sourcePanel);
        }
      } // end while
    }
  } // end method
  ...
  private void drawOneSourceLinks(java.util.Iterator destEntryIterator, java.awt.Graphics2D g2, java.awt.Point topLeftCornerScreenCoordinate, java.awt.Stroke oldStroke,
                                  float ratio, ActiveObjectPanel sourcePanel) {
