...
public class TypesHandler extends CollectionUnmarshaller {
	...
	HashMap componentTypes;
		...
		public TypesHandler(HashMap componentTypes) {
			...
			addHandler(ComponentsDescriptorConstants.COMPONENT_TYPE_TAG, new ComponentTypeHandler());
		}
	...
	protected void notifyEndActiveHandler(String name, UnmarshallerHandler activeHandler) throws SAXException {
		if (name.equals(ComponentsDescriptorConstants.COMPONENT_TYPE_TAG)) {
			...
			Object[] component_type_info = (Object[])getHandler(ComponentsDescriptorConstants.COMPONENT_TYPE_TAG).getResultObject();
