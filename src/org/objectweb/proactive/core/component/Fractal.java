...
public class Fractal {
    ...
    public static BindingController getBindingController(
        ...
        return (BindingController) component.getFcInterface(
            "binding-controller");
    }
    ...
    public static ContentController getContentController(
        final Component component) throws NoSuchInterfaceException {
        return (ContentController) component.getFcInterface(
            "content-controller");
    }
    ...
    public static LifeCycleController getLifeCycleController(
        final Component component) throws NoSuchInterfaceException {
        return (LifeCycleController) component.getFcInterface(
    ...
    /**
          ...
          * @throws NoSuchInterfaceException if there is no such interface.
          */
    public static TypeFactory getTypeFactory() throws NoSuchInterfaceException {
    ...
    public static ProActiveInterface createCollectiveClientInterface(
        ...
        throws InterfaceGenerationFailedException, ClassNotFoundException, 
