 ...
 *
 */
public class HandlerCreationException implements HandlerInterface {

    /** 
     * Is the exception handled by the handler ? 
     */
    public boolean isHandling(ProActiveException e) {
	if (e instanceof ProActiveCreationException)
	    return true;
	else
	    return false;
    }
	...
	System.out.println("*** Handle Creation Exception ***");
	e.printStackTrace();
    }
}
