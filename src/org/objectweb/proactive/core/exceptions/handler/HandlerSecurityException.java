 ...
 *
 */
public class HandlerSecurityException implements HandlerInterface {

    /** 
     * Is the exception handled by the handler ? 
     */
    public boolean isHandling(ProActiveException e) {
	if (e instanceof ProActiveSecurityException)
	    return true;
	else
	    return false;
    }
	...
	System.out.println("*** Handle Security Exception ***");
	e.printStackTrace();
    }
}
