 ...
 *
 */
public class ServiceFailedCalleeNFE extends ProActiveServiceException {
	...
	*/
	public ServiceFailedCalleeNFE(String s, Throwable ex) {
		super(s, ex);
	...
	* @param ex the nested exception
	*/
	public ServiceFailedCalleeNFE(Throwable ex) {
		super(ex);
		description = description + "Failed" + separator;
	}     
}
