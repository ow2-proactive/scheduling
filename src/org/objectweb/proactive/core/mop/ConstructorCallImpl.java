...
public class ConstructorCallImpl implements ConstructorCall, Serializable {
  ...
  public Object execute() throws InvocationTargetException, ConstructorCallExecutionFailedException {
    ...
    try {
      ...
      if (getReifiedClass().isInterface()) {
        ...
        throw new ConstructorCallExecutionFailedException("Cannot build an instance of an abstract class: " + e);
      } else {
        throw new ConstructorCallExecutionFailedException("Instanciation problem: " + e + ". Strange enough, the reified class is neither abstract nor an interface.");
      }
    } catch (ExceptionInInitializerError e) {
      throw new ConstructorCallExecutionFailedException("Cannot build object because the initialization of its class failed: " + e);
    }
  }
  ...
  private void readObject(java.io.ObjectInputStream in) throws IOException, ClassNotFoundException {
    ...
    try {
      ...
      throw new InternalException("Lookup for constructor failed: " + e + ". This may be caused by having different versions of the same class on different VMs. Check your CLASSPATH settings.");
    }
  }
}