...
public class StartRuntime
{
   ...
   */
	private void run(){
		...
		{
			proActiveRuntime.createLocalNode(nodeURL+Integer.toString(new java.util.Random(System.currentTimeMillis()).nextInt()),false);	
...
//		}
   ...
   */
	private void register(String hostName){
		...
		//PART.killRT();
		PART.register(proActiveRuntime,proActiveRuntime.getURL(),creatorID,acquisitionMethod);
