...
public interface RemoteProActiveRuntime extends Remote
{
  ...
  public void createVM(UniversalProcess remoteProcess) throws RemoteException,java.io.IOException;
  ...
  public void register(ProActiveRuntime proActiveRuntimeDist, String proActiveRuntimeName, String creatorID, String creationProtocol) throws RemoteException;
  ...
  public ProActiveRuntime getProActiveRuntime(String proActiveRuntimeName)throws RemoteException;
  ...
  public void killRT() throws RemoteException;
 	...
 	public ArrayList getActiveObjects(String nodeName) throws RemoteException;
 	
 	
 	public ArrayList getActiveObjects(String nodeName, String objectName) throws RemoteException;
 	
 	
  public VirtualNode getVirtualNode(String virtualNodeName) throws RemoteException;
  
  
  public void registerVirtualNode(String virtualNodeName,boolean replacePreviousBinding)throws RemoteException ;
  
  
  public void unregisterVirtualNode(String virtualNodeName)throws RemoteException;
  
  
  public UniversalBody createBody(String nodeName, ConstructorCall bodyConstructorCall,boolean isNodeLocal) throws RemoteException,
              ConstructorCallExecutionFailedException, java.lang.reflect.InvocationTargetException;


 
  public UniversalBody receiveBody(String nodeName, Body body) throws RemoteException;
}
