...
public class BodyRequest extends MessageImpl implements Request, java.io.Serializable {
  ...
  public BodyRequest(Body targetBody, String methodName, Class[] paramClasses, Object[] params, boolean isPriority) throws NoSuchMethodException {
    ...
    methodCall = MethodCall.getMethodCall(targetBody.getClass().getMethod(methodName, paramClasses), params);
