...
public class ActiveBody extends MigratableBody implements Runnable, java.io.Serializable {
   ...
   */
  public ActiveBody(ConstructorCall c, String nodeURL, Active activity, MetaObjectFactory factory) throws java.lang.reflect.InvocationTargetException, ConstructorCallExecutionFailedException {
