...
public class DefaultHandlerAdaptor extends org.xml.sax.helpers.DefaultHandler {
  ...
  */
  ...
  protected class AttributesImpl implements Attributes {
    ...
    public String getValue(int index) { return attributes.getValue(index); }
    public String getValue(String qName) { return attributes.getValue(qName); }
    public String getValue(String uri, String localPart) { return attributes.getValue(uri,localPart); }
  ...
  protected class EmptyAttributesImpl implements Attributes {
    ...
    public String getValue(String uri, String localPart) { return null; }
