...
* ################################################################
*/
package org.objectweb.proactive.core.node.oldies.jini;
...
public interface JiniNode extends java.rmi.Remote {

  /**
   * <p>
   * This method is the basis for creating jini active objects.
   ...
   * </p><p>
   * The method returns a reference on the JINI stub of the newly created body.
   * </p>
   * @param bodyConstructorCall the Constructor call allowing to create the body
   * @return a JINI stub on the newly created body.
   ...
   * </p><p>
   * The method returns a reference on the JINI stub of the migrated body.
   * </p>
   * @param <code>body</code> the body of the active object migrating to this node.
   * @return a JINI stub on the migrated body.
   * @exception java.rmi.RemoteException if a problem occurs due the remote nature of the node
   */
