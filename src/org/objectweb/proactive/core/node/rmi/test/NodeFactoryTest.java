package org.objectweb.proactive.core.node.rmi.test;
...
public class NodeFactoryTest extends TestCase {
	...
	public static Test suite() {
		...
		suite.addTest(new NodeFactoryTest("testCreateNode"));
		return suite;
	}

	public NodeFactoryTest(String str) {
		super(str);
	}
	...
	public static void main(String[] args) {
		NodeFactoryTest test = new NodeFactoryTest("testCreateNode");
