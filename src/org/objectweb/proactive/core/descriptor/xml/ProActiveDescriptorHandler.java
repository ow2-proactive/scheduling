...
public class ProActiveDescriptorHandler extends AbstractUnmarshallerDecorator implements ProActiveDescriptorConstants {
  ...
  public ProActiveDescriptorHandler(String xmlDescriptorUrl) {
	...
	addHandler(MAIN_DEFINITION_TAG, new MainDefinitionHandler(proActiveDescriptor, xmlDescriptorUrl));
    addHandler(DEPLOYMENT_TAG, new DeploymentHandler(proActiveDescriptor, xmlDescriptorUrl));
