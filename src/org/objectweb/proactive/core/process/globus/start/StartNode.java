...
* ################################################################
*/ 
package org.objectweb.proactive.core.process.globus.start;
...
public class StartNode {
  ...
  private static final String XML_LOCATION = System.getProperty("user.dir")+FS+".."+FS+"descriptors"+FS+"RemoteGlobusSetup.xml";
  ...
  protected static GlobusProcess gp;
  ...
  public static void main(String[] args) {
    ...
    // If we launch the node with globus
    ...
    // else we launch the node with the normal method
    else{
      try {
  ...
  /**
   * return a reference on the globus process used to launch the node.
   * null if globus is not used.
   * this method is used in c3d to syncronised the dispatcher with the creation of the node.
   */

  public GlobusProcess getGlobusProcess(){
    return gp;
  }
