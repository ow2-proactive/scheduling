...
//
//   /**
//   * This method launch a class on a remote host 
//   * @param rslCommand to generate with buildRSLCommand
//   */
...
public class GlobusProcess extends AbstractExternalProcessDecorator {
  ...
  public GlobusProcess(JVMProcess process){
   ...
   return buildRSLCommand();
	...
	String RSL = "& (executable = "+DEFAULT_SCRIPT_LOCATION+")(count=5)";
	...
	private String buildRSLCommand()
	{
		String RSLCommand = "& (executable = "+scriptLocation+")(arguments='"+getTargetProcess().getCommand()+"')(count="+count+")(jobType=single)";
		
//		if (count != null) RSLCommand = RSLCommand+"(count="+count+")";
//		RSLCommand = RSLCommand+"(jobType=single)";
		if(environment != null) RSLCommand = RSLCommand + "(environment="+buildEnvironmentCommand()+")";
		return RSLCommand;
//		String rslCommand ="&(executable=" + ((JVMProcess)targetProcess).getJavaPath()+")" + 
