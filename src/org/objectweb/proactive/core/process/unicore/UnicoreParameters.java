...
public class UnicoreParameters implements java.io.Serializable{
	...
	public void setParameter(String name, String value){
		...
		if(name.length() < 2 || value.length()<=0) return;
		if(name.charAt(0) == '-') name=name.substring(1);
		
		if (name.equalsIgnoreCase("jobname"))	setJobName(value);
		else if(name.equalsIgnoreCase("keypassword")) setKeyPassword(value);
		else if(name.equalsIgnoreCase("submitjob")) setSubmitJob(value);
		else if(name.equalsIgnoreCase("savejob")) setSaveJob(value);
		else if(name.equalsIgnoreCase("unicoredir")) setUnicoreDir(value);
		else if(name.equalsIgnoreCase("keyfilepath")) setKeyFilePath(value);
		else if(name.equalsIgnoreCase("usitename")) setUsiteName(value);
		else if(name.equalsIgnoreCase("usitetype")) setUsiteType(value);
		else if(name.equalsIgnoreCase("usiteurl")) setUsiteUrl(value);
		else if(name.equalsIgnoreCase("vsitename")) setVsiteName(value);
		else if(name.equalsIgnoreCase("vsitenodes")) setVsiteNodes(value);
		else if(name.equalsIgnoreCase("vsiteprocessors")) setVsiteProcessors(value);
		...
		else if(name.equalsIgnoreCase("deploymentFile")) addDeploymentFile(value);
		else if(name.equalsIgnoreCase("deploymentDir")) addDeploymentDir(value);
