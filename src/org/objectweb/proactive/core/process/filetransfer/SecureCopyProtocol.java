...
public class SecureCopyProtocol extends AbstractCopyProtocol {
	...
	public boolean startFileTransfer() {
		...
		String allCommands [] = new String[homocommand.length()>0 ? heterocommand.length+1 :heterocommand.length ];
		
		if(homocommand.length() > 0) allCommands[allCommands.length - 1]=homocommand;
	...
	static public void main(String args[]){
		...
		fts.dstInfoParams.setInfoParameter("prefix", "/auto/owenii/u/owenii/home/mleyton");
