...
public class UrlBuilder
{
  ...
  //
	 ...
	 */
	public static String checkUrl(String url) throws java.net.UnknownHostException{
...
//		System.out.println("########vn url "+url);
  ...
  public static String getHostNameFromUrl(String url) throws java.net.UnknownHostException{
  ...
  private static String readHostAndName(String urlToRead) throws java.net.UnknownHostException {
    ...
    if (n < 3) throw new java.net.UnknownHostException("Cannot determine the name of the host in this url="+urlToRead);
    // get the host
