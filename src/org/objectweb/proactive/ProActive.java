...
public class ProActive {
	...
	static {
		...
		setExceptionHandler(IHandler.ID_defaultLevel, null, HandlerNonFunctionalException.class, NonFunctionalException.class);
		setExceptionHandler(IHandler.ID_defaultLevel, null, HandlerCommunicationException.class, ProActiveCommunicationException.class);
		setExceptionHandler(IHandler.ID_defaultLevel, null, HandlerCreationException.class, ProActiveCreationException.class);
		setExceptionHandler(IHandler.ID_defaultLevel, null, HandlerGroupException.class, ProActiveGroupException.class);
		setExceptionHandler(IHandler.ID_defaultLevel, null, HandlerMigrationException.class, ProActiveMigrationException.class);
		setExceptionHandler(IHandler.ID_defaultLevel, null, HandlerSecurityException.class, ProActiveSecurityException.class);
		setExceptionHandler(IHandler.ID_defaultLevel, null, HandlerServiceException.class, ProActiveServiceException.class);
	}
	...
	public static ProActiveDescriptor getProactiveDescriptor(
		...
		try {
			System.out.println("************* Reading deployment descriptor: " +
				xmlDescriptorUrl + " ********************");
	...
	/**
	  ...
	  public static IHandler searchExceptionHandler(NonFunctionalException ex) {
			...
			if ((handler = searchExceptionHandler(ex, codeLevel, IHandler.ID_codeLevel)) != null) return handler;
			...
			if ((handler = searchExceptionHandler(ex, VMLevel, IHandler.ID_VMLevel)) != null) return handler;
	 ...
	 * @return A reliable handler or null if no handler is available
	 */
	public static IHandler searchExceptionHandler(NonFunctionalException ex, HashMap level, int levelID) {
	...
	public static void setExceptionHandler(int ID_level, Object obj, Class hName, Class exName) {
		...
		HashMap level = null;
		switch (ID_level) {
			case (IHandler.ID_defaultLevel) : level = defaultLevel;
			break;
			case (IHandler.ID_VMLevel) : level = VMLevel;
			break;
	 ...
	 */
	public static IHandler unsetExceptionHandler(int ID_level, Object obj, Class exName) {
