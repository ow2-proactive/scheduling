...
public class ProActive {
    ...
    static {
        ...
        setExceptionHandler(defaultLevel,
            HandlerProActiveException.class.getName(),
            ProActiveException.class.getName());
        setExceptionHandler(defaultLevel,
            HandlerCommunicationException.class.getName(),
            ProActiveCommunicationException.class.getName());
        setExceptionHandler(defaultLevel,
            HandlerCreationException.class.getName(),
            ProActiveCreationException.class.getName());
        setExceptionHandler(defaultLevel,
            HandlerGroupException.class.getName(),
            ProActiveGroupException.class.getName());
        setExceptionHandler(defaultLevel,
            HandlerMigrationException.class.getName(),
            ProActiveMigrationException.class.getName());
        setExceptionHandler(defaultLevel,
            HandlerSecurityException.class.getName(),
            ProActiveSecurityException.class.getName());
        setExceptionHandler(defaultLevel,
            HandlerServiceException.class.getName(),
            ProActiveServiceException.class.getName());
    }
     ...
     */
    public static HandlerInterface searchExceptionHandler(HashMap level,
        ProActiveException ex) {
        ...
        while ((handler == null) &&
                (exClass.getName().compareTo(ProActiveException.class.getName()) != 0)) {
            // System.out.println("*** search " + exClass.getName());
            if (level.containsKey(exClass.getName())) {
                try {
                    handler = (HandlerInterface) Class.forName((String) level.get(
                                exClass.getName())).newInstance();
                } catch (Exception e) {
                    if (e instanceof ClassNotFoundException) {
                        System.out.println("*** Handler for " +
                            exClass.getName() + " is invalid");
     ...
     */
    public static void setExceptionHandler(HashMap level, String hName,
        String exName) {
     ...
     */
    public static HandlerInterface unsetExceptionHandler(HashMap level,
        String exName) {
        ...
        if (level != defaultLevel) {
            try {
                handler = (HandlerInterface) Class.forName((String) level.remove(
                            exName)).newInstance();
            } catch (Exception e) {
                e.printStackTrace();
            }
