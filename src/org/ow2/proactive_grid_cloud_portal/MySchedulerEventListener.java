...
public class MySchedulerEventListener implements SchedulerEventListener{

    private SchedulerState schedulerState = null;

    public MySchedulerEventListener(Scheduler scheduler) throws ProActiveException, NotConnectedException, PermissionException {
