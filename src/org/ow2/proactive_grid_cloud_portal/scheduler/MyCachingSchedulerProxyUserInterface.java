...
public class MyCachingSchedulerProxyUserInterface extends CachingSchedulerProxyUserInterface {
     ...
     */
    public void init(String url, String user, String pwd, boolean myEventsOnly) throws SchedulerException,
            LoginException {
        ...
        try {
            ao = (CachingSchedulerProxyUserInterface) MOP.createStubObject(body.getReifiedObject(),
                    new Object[] { body }, CachingSchedulerProxyUserInterface.class.getName(), null);
     ...
     * @throws LoginException if the couple username/password is invalid
     */
    public void init(String url, CredData credData, boolean myEventsOnly) throws SchedulerException,
            LoginException {
        SchedulerAuthenticationInterface auth = SchedulerConnection.join(url);
        PublicKey pubKey = auth.getPublicKey();
