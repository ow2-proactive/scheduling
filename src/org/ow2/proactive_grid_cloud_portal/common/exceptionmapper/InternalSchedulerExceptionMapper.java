...
@Provider
public class InternalSchedulerExceptionMapper implements ExceptionMapper<InternalSchedulerException> {

    public Response toResponse(InternalSchedulerException exception) {
