...
IF EXIST %PROACTIVE%\lib\components\fractal.jar set CLASSPATH=%CLASSPATH%;%PROACTIVE%\lib\fractal.jar
IF EXIST %PROACTIVE%\lib\components\fractal-adl.jar set CLASSPATH=%CLASSPATH%;%PROACTIVE%\lib\fractal-adl.jar
IF EXIST %PROACTIVE%\lib\components\dtdparser.jar set CLASSPATH=%CLASSPATH%;%PROACTIVE%\lib\dtdparser.jar
IF EXIST %PROACTIVE%\lib\components\ow_deployment_scheduling.jar set CLASSPATH=%CLASSPATH%;%PROACTIVE%\lib\ow_deployment_scheduling.jar
IF EXIST %PROACTIVE%\lib\components\fractal-gui.jar set CLASSPATH=%CLASSPATH%;%PROACTIVE%\lib\fractal-gui.jar
IF EXIST %PROACTIVE%\lib\components\fractal-swing.jar set CLASSPATH=%CLASSPATH%;%PROACTIVE%\lib\fractal-swing.jar
IF EXIST %PROACTIVE%\lib\components\julia-asm.jar set CLASSPATH=%CLASSPATH%;%PROACTIVE%\lib\julia-asm.jar
IF EXIST %PROACTIVE%\lib\components\julia-mixins.jar set CLASSPATH=%CLASSPATH%;%PROACTIVE%\lib\julia-mixins.jar
IF EXIST %PROACTIVE%\lib\components\julia-runtime.jar set CLASSPATH=%CLASSPATH%;%PROACTIVE%\lib\julia-runtime.jar
IF EXIST %PROACTIVE%\lib\components\SVGGraphics.jar set CLASSPATH=%CLASSPATH%;%PROACTIVE%\lib\SVGGraphics.jar
