 ...
 * <dd>(Most) GTK themes draw the Text border, rather than a border around the whole
 * combo, thus CCombo stands out as distinctly non-native - especially GNOME's new 
 * standard "ClearLooks" which shows the gray background between Text and Arrow and
 * border</dd>
 * <dt>Arrow gets the focus:</dt>
 * <dd>It used to take two tabs to cross a CCombo.  Solution: if the arrow gets a
 * SWT.FOCUS_IN event, ignore it and setFocus to the Text</dd>
...
public final class ImageCombo extends Composite {
    ...
    static int checkStyle(int style) {
        int mask = gtk ? SWT.READ_ONLY | SWT.FLAT | SWT.LEFT_TO_RIGHT | SWT.RIGHT_TO_LEFT : SWT.BORDER |
