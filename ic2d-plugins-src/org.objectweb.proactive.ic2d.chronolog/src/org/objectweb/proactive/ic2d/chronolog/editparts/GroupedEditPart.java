 ...
 *
 */
public final class GroupedEditPart extends
        AbstractChronologEditPart<GroupedNumberBasedTypeModel, BIRTChartCanvas> {

    private final BIRTChartBuilder chartBuilder;

    public GroupedEditPart(final GroupedNumberBasedTypeModel dataElementModel) {
