...
public interface SchedulerRestInterface {
	...
	@Produces("application/json")
	boolean pauseJob(@HeaderParam("sessionid") final String sessionId, @PathParam("jobid") final String jobId)
			throws NotConnectedRestException, UnknownJobRestException, PermissionRestException;
	...
	@Produces("application/json")
	boolean restartAllInErrorTasks(@HeaderParam("sessionid") final String sessionId,
	...
	@Produces("application/json")
	boolean resumeJob(@HeaderParam("sessionid") final String sessionId, @PathParam("jobid") final String jobId)
			throws NotConnectedRestException, UnknownJobRestException, PermissionRestException;
	...
	@Path("disconnect")
	@Produces("application/json")
	void disconnect(@HeaderParam("sessionid") final String sessionId)
			throws NotConnectedRestException, PermissionRestException;
	...
	@Path("pause")
	@Produces("application/json")
	boolean pauseScheduler(@HeaderParam("sessionid") final String sessionId)
			throws NotConnectedRestException, PermissionRestException;
	...
	@Path("stop")
	@Produces("application/json")
	boolean stopScheduler(@HeaderParam("sessionid") final String sessionId)
			throws NotConnectedRestException, PermissionRestException;
	...
	@Path("resume")
	@Produces("application/json")
	boolean resumeScheduler(@HeaderParam("sessionid") final String sessionId)
			throws NotConnectedRestException, PermissionRestException;
	...
	void schedulerChangeJobPriorityByName(@HeaderParam("sessionid") final String sessionId,
	...
	void schedulerChangeJobPriorityByValue(@HeaderParam("sessionid") final String sessionId,
	...
	@Path("freeze")
	@Produces("application/json")
	boolean freezeScheduler(@HeaderParam("sessionid") final String sessionId)
			throws NotConnectedRestException, PermissionRestException;
	...
	@Path("status")
	@Produces("application/json")
	SchedulerStatusData getSchedulerStatus(@HeaderParam("sessionid") final String sessionId)
			throws NotConnectedRestException, PermissionRestException;
	...
	@Path("start")
	@Produces("application/json")
	boolean startScheduler(@HeaderParam("sessionid") final String sessionId)
			throws NotConnectedRestException, PermissionRestException;
	...
	@Path("kill")
	@Produces("application/json")
	boolean killScheduler(@HeaderParam("sessionid") final String sessionId)
			throws NotConnectedRestException, PermissionRestException;
	...
	@Path("linkrm")
	@Produces("application/json")
	boolean linkRm(@HeaderParam("sessionid") final String sessionId, @FormParam("rmurl") String rmURL)
			throws NotConnectedRestException, PermissionRestException;
	...
	@Path("isconnected")
	@Produces("application/json")
	boolean isConnected(@HeaderParam("sessionid") final String sessionId) throws NotConnectedRestException;
	...
	@Path("userswithjobs")
	@Produces("application/json")
	List<SchedulerUserData> getUsersWithJobs(@HeaderParam("sessionid") final String sessionId)
			throws NotConnectedRestException, PermissionRestException;
	...
	@Path("stats")
	@Produces("application/json")
	Map<String, String> getStatistics(@HeaderParam("sessionid") final String sessionId)
			throws NotConnectedRestException, PermissionRestException;
	...
	@Produces("application/json")
	Map<String, String> getStatisticsOnMyAccount(@HeaderParam("sessionid") final String sessionId)
			throws NotConnectedRestException, PermissionRestException;
