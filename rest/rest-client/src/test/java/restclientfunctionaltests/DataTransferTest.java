...
public class DataTransferTest extends AbstractRestFuncTestCase {
    ...
    static URL zipFileUrl = DataTransferTest.class.getResource("/restclientfunctionaltests/files/test1.zip");

    static URL tgzFileUrl = DataTransferTest.class.getResource("/restclientfunctionaltests/files/test2.tgz");
