...
public class LiveLogsCommand extends AbstractJobCommand {
    public LiveLogsCommand(String jobId) {
        super(jobId);
    }
    ...
    public void execute(ApplicationContext currentContext) throws CLIException {
        ...
        writeLine(currentContext, "Displaying logs for job %s. Press 'q' to stop.", jobId);
        try {
            while (true) {
            ...
            handleError("An error occurred while listening to job logs", e, currentContext);
        }
    }
}
