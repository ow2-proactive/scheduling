...
public class GetNodeThreadDumpCommand extends AbstractCommand implements Command {

    private String nodeUrl;

    public GetNodeThreadDumpCommand(String nodeUrl) {
        this.nodeUrl = nodeUrl;
    }

    @Override
    public void execute(ApplicationContext context) throws CLIException {
        HttpGet request = buildGetNodeThreadDumpRequest(context);
