...
public class RestartInErrorTaskCommand extends AbstractTaskCommand implements Command {

    public RestartInErrorTaskCommand(String jobId, String taskId) {
        super(jobId, taskId);
    }
    ...
    private void handleResult(ApplicationContext currentContext, boolean result) {
        ...
        if (result) {
            writeLine(currentContext, "In-Error %s successfully restarted.", task());
        } else {
