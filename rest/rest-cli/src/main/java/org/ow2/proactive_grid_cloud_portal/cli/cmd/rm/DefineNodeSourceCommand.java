...
public class DefineNodeSourceCommand extends NodeSourceCommand {
    ...
    public void execute(ApplicationContext currentContext) throws CLIException {
        ...
        HttpResponseWrapper response = executeRequestWithQuery(currentContext, queryStringBuilder, HttpVerb.POST);
