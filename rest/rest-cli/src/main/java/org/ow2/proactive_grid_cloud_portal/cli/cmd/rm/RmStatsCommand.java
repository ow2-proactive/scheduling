...
public class RmStatsCommand extends AbstractCommand implements Command {
    private static final String[] RUNTIME_DATA_ATTR = new String[] { "MaxBusyNodes", "MaxConfiguringNodes",
            "ToBeReleasedNodesCount", "DeployingNodesCount", "MaxDeployingNodes", "BusyNodesCount",
            "AvailableNodesCount", "MaxLostNodes", "MaxFreeNodes", "AverageInactivity", "Status",
            "LostNodesCount", "FreeNodesCount", "DownNodesCount", "AverageActivity", "MaxDownNodes",
