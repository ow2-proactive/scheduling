 ...
 *
 */
public class RESTfulRMHostMemClient extends BaseRESTfulRMHostClient {

    @Override
    protected String getQueryUrl(String serverUrl, String jmxUrl) {
        return MBeanQueries.getQueryUrl(serverUrl, MBeanQueries.getResourcePath(MBeanQueries.MBEAN_MEM),
                jmxUrl, MBeanQueries.QUERY_MEM);
    }
