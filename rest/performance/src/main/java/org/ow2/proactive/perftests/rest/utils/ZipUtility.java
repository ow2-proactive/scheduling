...
public class ZipUtility {
    ...
    public static void unzipFile(String zipFile, String outputDirectory, HostTestEnv env)
        ...
        ProcessExecutor executor = env.runCommandSaveOutput("unzipFile", command);
        if (!executor.executeAndWaitCompletion(10000, true)) {
            throw new TestExecutionException("Failed to execute command to unzipFile");
        }
