...
public class RMRest implements RMRestInterface {
    ...
    public String rmConnect(@FormParam("username") String username, @FormParam("password") String password)
        ...
        session.connectToRM(
                new CredData(CredData.parseLogin(username), CredData.parseDomain(username), password));
    ...
    public boolean removeNodeSource(@HeaderParam("sessionid") String sessionId,
            @FormParam("name") String sourceName, @FormParam("preempt") boolean preempt)
            throws NotConnectedException {
        ResourceManager rm = checkAccess(sessionId);
    ...
    @Path("stathistory")
    @Produces("application/json")
    public String getStatHistory(@HeaderParam("sessionid") String sessionId,
    ...
    public List<ScriptResult<Object>> executeNodeSourceScript(@HeaderParam("sessionid") String sessionId,
        ...
        return rm.executeScript(script, scriptEngine, TargetType.NODESOURCE_NAME.name(),
    ...
    public List<ScriptResult<Object>> executeHostScript(@HeaderParam("sessionid") String sessionId,
        ...
        return rm.executeScript(script, scriptEngine, TargetType.HOSTNAME.name(),
    ...
    @Path("nodesource")
    @Produces("application/json")
    public ArrayList<RMNodeSourceEvent> getExistingNodeSources(@HeaderParam("sessionid") String sessionId)
            throws NotConnectedException {
        ResourceManager rm = checkAccess(sessionId);
