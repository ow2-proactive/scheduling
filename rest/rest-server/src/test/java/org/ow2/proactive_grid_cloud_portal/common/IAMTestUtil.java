...
public class IAMTestUtil {
    ...
    public static void setUpIAM() {
        ...
        config.setProperty(IAMConfiguration.IAM_PASS_CRYPTO_ENABLED, true);
        config.setProperty(IAMConfiguration.IAM_PASS_SIGNATURE_KEY, "");
        config.setProperty(IAMConfiguration.IAM_PASS_ENCRYPTION_KEY, "");
