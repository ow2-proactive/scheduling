...
public enum RestCommand {
	...
	GET_JOB_RESULT("jr", "jobresult", "Retrieve the result of specified job",
			"job_id", 1, false, "joboutput(job_id)"),
	...
	EVAL_SCRIPT(
			"sf", "script", "Evaluate the specified JavaScript file",
			"script-pathname [param1=value1,param2=value2...]", 2, false, "script(script-pathname,param-value)"),
