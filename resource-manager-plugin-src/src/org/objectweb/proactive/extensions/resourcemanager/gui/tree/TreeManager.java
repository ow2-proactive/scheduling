...
public class TreeManager extends LabelProvider implements IStructuredContentProvider, ITreeContentProvider {
	...
	public Image getImage(Object obj) {
		...
		case NODE:
			...
			case DOWN:
				return ImageDescriptor.createFromFile(this.getClass(), "icons/down.gif").createImage();
			case FREE:
				return ImageDescriptor.createFromFile(this.getClass(), "icons/free.gif").createImage();
			case BUSY:
			case TO_BE_RELEASED:
				return ImageDescriptor.createFromFile(this.getClass(), "icons/busy.gif").createImage();
			}
			break;
		case SOURCE:
