 ...
 */
public class SelectNodeControl extends ControlAdapter {
     ...
     */
    public SelectNodeControl(String focusGroup) {
        this(1);
        group = focusGroup;
    }
     ...
     * @param clicks the number of clicks needed to switch the focus.
     */
    public SelectNodeControl(String focusGroup, int clicks) {
        ccount = clicks;
        group = focusGroup;
    }
     ...
     */
    public SelectNodeControl(int clicks, String act) {
        ccount = clicks;
        activity = act;
    }
     ...
     * @param act an action run to upon focus change
     */
    public SelectNodeControl(String focusGroup, int clicks, String act) {
        ccount = clicks;
        activity = act;
